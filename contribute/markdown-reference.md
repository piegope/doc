...
Ex: File – Options – User Interface – Navigation Pane.  
...
* Avoid using H1 headings, as they are reserved for the title and navigation tree.
...
Would result in the following outcome:  
