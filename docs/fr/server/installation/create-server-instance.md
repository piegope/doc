...
![Déployer un nouveau {{ fr.RDMS }}](https://webdevolutions.azureedge.net/docs/fr/server/ServerOp8048.png) 
...
![Convention de licence {{ fr.RDMS }}](https://webdevolutions.azureedge.net/docs/fr/server/ServerOp8050.png) 
...
![Assistant de déploiement {{ fr.RDMS }}](https://webdevolutions.azureedge.net/docs/fr/server/ServerOp8054.png) 
...
![Assistant d'installation de {{ fr.RDMS }}](https://webdevolutions.azureedge.net/docs/fr/server/ServerOp8051.png) 
