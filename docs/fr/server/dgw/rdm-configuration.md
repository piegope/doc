...
1. Dans l'onglet ***Paramètres (Devolutions Gateway)***, sélectionner la passerelle configurée dans la [Configuration pour le {{ fr.DVLS }}](/fr/server/dgw/server-configuration/).  
