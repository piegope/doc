...
Vous pouvez créer un nouvel ensemble qui réponde à vos besoins spécifiques :

1. Dans ***Administration – Paramètres système – Gestion des {{ fr.VLT }}s – Ensembles de permissions***, cliquer sur le bouton ***Ajouter***.

   ![Ajouter un ensemble de permissions](https://webdevolutions.azureedge.net/docs/fr/server/ServerOp2061.png)

1. Donner un ***Nom*** à votre ensemble personnalisé et cocher chaque permission que vous voulez inclure dans l'ensemble.

   ![Personnalisation de l'ensemble de permissions](https://webdevolutions.azureedge.net/docs/fr/server/ServerOp2062.png)
...
1. Cliquer sur ***OK***.
   ...
   ![Survol de l'ensemble de permissions personnalisé](https://webdevolutions.azureedge.net/docs/fr/server/ServerOp2063.png)
