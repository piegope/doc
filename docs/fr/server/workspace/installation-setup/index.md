...
eleventyComputed:
  ...
  description: "{{ fr.DWS }} est un outil d'application mobile et de bureau disponible sur notre page de téléchargement de {{ fr.DWS }} qui peut être utilisé avec {{ fr.DVLS }}."
---
