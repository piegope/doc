---
eleventyComputed:
  title: Synchronisation de {{ fr.DEVL }} et {{ fr.DVLS }}
  order: 20
---
{{ fr.DEVL }} et {{ fr.DVLS }} doivent être configurés ensemble. Le lancement de connexions peut être défini pour tous les utilisateurs dans les ***Paramètres de {{ fr.DVLS }}*** ou individuellement dans les ***Paramètres du compte***.  
...
Dans ***Administration - Paramètres Serveur - Avancé***, utiliser le menu déroulant ***Lancer une connexion avec*** pour sélectionner ***{{ fr.DEVL }}*** .  
...
1. Choisir ***{{ fr.DEVL }}*** dans le menu déroulant de ***Lancer une connexion avec*** et ***Enregistrer***. 
