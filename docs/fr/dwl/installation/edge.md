...
![{{ fr.DWL }} dans les Modules complémentaires Edge.png](https://webdevolutions.azureedge.net/docs/fr/dwl/Dwl4047.png)
1. Cliquer sur ***Ajouter une extension***.  
![Ajouter {{ fr.DWL }} à Microsoft Edge.png](https://webdevolutions.azureedge.net/docs/fr/dwl/Dwl4013.png)  
