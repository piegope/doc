...
***{{ fr.HUB }}*** ***Importer*** est un outil essentiel conçu pour importer vos données dans {{ fr.HUB }} Business.  
...
1. ***Sélectionner l 'hôte de votre*** ***{{ fr.HUB }}*** ***Business*** et cliquer ***Se connecter*** .  
