...
---
Enregistrer les ***Licences de produit*** Devolutions dans {{ fr.HUBB }}.  
{% snippet icon.badgeCaution %} 
Seuls les ***Administrateurs*** et les utilisateurs disposant des permissions dans la section ***Permissions du système*** auront accès à l’enregistrement d’une licence dans {{ fr.HUBB }}. 
{% endsnippet %}
