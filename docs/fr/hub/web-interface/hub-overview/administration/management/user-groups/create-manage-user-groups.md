...
---
La gestion des utilisateurs et des permissions peuvent être simplifiées avec les ***Groupes d'utilisateurs*** dans {{ fr.HUB }} Business.  
...
La gestion et l'ajout d'utilisateurs aux ***Groupes d'utilisateurs*** dans {{ fr.HUB }} Business peuvent être effectués de plusieurs manières: 
