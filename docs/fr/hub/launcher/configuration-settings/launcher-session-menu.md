...
order: 30
---
Pour accéder au menu de la session {{ en.LAUNCHER }}, faire un clic droit sur un onglet de session ouvert.  
![!!Hub4015.png](https://webdevolutions.azureedge.net/docs/fr/hub/Hub4015.png) 

### Désancrer 

Pour désancrer une session dans {{ en.LAUNCHER }}, cliquer avec le bouton droit sur l'onglet pour ouvrir le menu de sélection et cliquer sur ***Désancrer***.  
