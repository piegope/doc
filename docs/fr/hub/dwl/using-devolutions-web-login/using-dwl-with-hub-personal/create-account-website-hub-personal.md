---
eleventyComputed:
  title: Créer un compte de site Web dans {{ fr.HUBP }} avec {{ fr.DWL }}
  order: 10
---
...
Suivez les étapes ci-dessous pour créer un compte de site Web avec {{ fr.DWL }} et sauvegarder vos identifiants dans {{ fr.HUBP }}.  
