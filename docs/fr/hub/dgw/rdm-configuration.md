...
1. Dans l'onglet ***Paramètres (Devolutions Gateway)***, sélectionner la passerelle configurée dans la [Configuration {{ fr.HUB }}](/hub/dgw/fr/hub-business-configuration/index/).  
