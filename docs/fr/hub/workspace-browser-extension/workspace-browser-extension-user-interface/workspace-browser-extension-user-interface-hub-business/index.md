...
* l'onglet ***{{ fr.VLT }}s***, où vous pouvez trouver toutes les entrées de {{ fr.DHUBB }} que vous avez synchronisées, réparties dans vos différents {{ fr.VLT }}s et dossiers; 
