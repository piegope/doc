...
![Installer le {{ fr.WBEX }}](https://webdevolutions.azureedge.net/docs/fr/dwl/Dwl4007.png)
1. Cliquer sur le bouton ***Extensions*** d'Opera et ***Épingler*** le {{ fr.WBEX }} pour terminer l'installation.  
![Épingler le {{ fr.WBEX }}](https://webdevolutions.azureedge.net/docs/fr/dwl/Dwl4046.png)  
