...
![{{ fr.WBEX_MAJ }} dans les Modules complémentaires Edge](https://webdevolutions.azureedge.net/docs/fr/dwl/Dwl4047.png)
1. Cliquer sur ***Ajouter une extension***.  
![Ajouter le {{ fr.WBEX }} à Microsoft Edge](https://webdevolutions.azureedge.net/docs/fr/dwl/Dwl4013.png)  
