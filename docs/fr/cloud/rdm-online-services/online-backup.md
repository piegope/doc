...
Consultez [Configuration de la sauvegarde - Édition Windows](https://helprdm.devolutions.net/fr/file_backup_settings.html) ou [Configuration de la sauvegarde - Édition Mac](/fr/rdm/mac/commands/file/backup/settings/)pour plus d'informations.  
