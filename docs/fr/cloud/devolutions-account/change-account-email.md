...
* [Hub Personal](/fr/cloud/hub-personal/) : Importer et exporter vos entrées de source de données {{ fr.HUB }} Personal [avec {{ fr.RDM }}](/fr/kb/remote-desktop-manager/how-to-articles/export-import-entries/) ou au format Json directement [à partir de {{ fr.HUB }} Personal (EN)](/kb/hub-business/how-to-articles/import-export-data-hub-personal/) dans ***Outils – Exporter*** .  
