...
---
La fonction ***Importer plusieurs {{ fr.VLT }}s (.rdx)*** permet d'importer un ou plusieurs {{ fr.VLT }}s à la fois. Découvrir comment dans [Export and import vaults (EN)](/kb/remote-desktop-manager/how-to-articles/export-import-vaults/).
...
![!!RdmWin2000](https://webdevolutions.azureedge.net/docs/fr/rdm/windows/RdmWin2000.png) 
