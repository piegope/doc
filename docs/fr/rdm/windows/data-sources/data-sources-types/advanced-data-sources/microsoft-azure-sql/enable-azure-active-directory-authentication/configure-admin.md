...
![!!RdmWin4027](https://webdevolutions.azureedge.net/docs/fr/rdm/windows/RdmWin4027.png) 
1. Cliquer sur ***Active Directory admin*** sous ***Settings*** dans le menu de gauche.  
![!!RdmWin4028](https://webdevolutions.azureedge.net/docs/fr/rdm/windows/RdmWin4028.png) 
1. Cliquer sur ***Set admin*** pour rechercher l'administrateur.  
![!!RdmWin4029](https://webdevolutions.azureedge.net/docs/fr/rdm/windows/RdmWin4029.png) 
...
![!!RdmWin4030](https://webdevolutions.azureedge.net/docs/fr/rdm/windows/RdmWin4030.png) 
1. Pour terminer le processus, cliquer sur ***Save***.  
![!!RdmWin4031](https://webdevolutions.azureedge.net/docs/fr/rdm/windows/RdmWin4031.png) 
