...
Si une demande d'accès temporaire a été faite dans {{ fr.RDM }} à partir d'une base de données {{ fr.HUB }}, le processus d'autorisation doit être effectué dans {{ fr.HUB }}. Consultez [Approuver un accès temporaire à une entrée dans {{ fr.DHUBB }}](/fr/hub/web-interface/hub-overview/temporary-access/approve-temporary-access/). 
{% endsnippet %}
...
![Afficher les Demandes d'accès temporaire](https://webdevolutions.azureedge.net/docs/fr/rdm/windows/RDMWin6001.png) 
...
![Demandes d'accès en attente](https://webdevolutions.azureedge.net/docs/fr/rdm/windows/RDMWin6002.png) 
...
![Réponse à la demande d'accès temporaire](https://webdevolutions.azureedge.net/docs/fr/rdm/windows/RDMWin6003.png) 
