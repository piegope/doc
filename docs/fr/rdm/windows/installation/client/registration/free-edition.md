...
{% snippet icon.badgeInfo %} 
Vous devrez quand même [créer un {{ fr.DA }}](https://login.devolutions.com/op/register) gratuit pour utiliser et accéder aux [{{ fr.DCS }}](/fr/cloud/getting-started/devolutions-cloud-services/) et aux [{{ fr.RDMOS }}](/fr/cloud/rdm-online-services/) . 
{% endsnippet %}
