...
![Écran principal {{ fr.RDM }} - Style ruban](https://webdevolutions.azureedge.net/docs/fr/rdm/mac/clip4320.png) 

### Classique 

Style classique de version précédente, il contient un menu standard pour invoquer des commandes.  
![Écran principal {{ fr.RDM }} - Style classique](https://webdevolutions.azureedge.net/docs/fr/rdm/mac/clip4321.png) 
