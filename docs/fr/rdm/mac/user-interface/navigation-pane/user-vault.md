...
Pour créer une nouvelle entrée dans votre {{ fr.UVLT }} , cliquer sur {{ fr.UVLT }} dans votre Volet de navigation et créer votre nouvelle entrée directement à partir de là.  
