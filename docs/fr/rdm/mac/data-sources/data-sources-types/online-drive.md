...
![{{ fr.DOD }} - Général](https://cdnweb.devolutions.net/docs/fr/rdm/mac/clip4266.png)
...
![{{ fr.DOD }} - Sauvegarde](https://cdnweb.devolutions.net/docs/fr/rdm/mac/clip4267.png)
...
![!!RDMMac4045](https://cdnweb.devolutions.net/docs/fr/rdm/mac/RdmMac4045.png)

### Avancée

![{{ fr.DOD }} - Avancée](https://cdnweb.devolutions.net/docs/fr/rdm/mac/clip4268.png)
