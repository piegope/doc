...
---
Le Cisco AnyConnect rencontre des problèmes lors de la connexion.
### L'entrée cisco anyconnect est manquante dans la nouvelle fenêtre d'entrée
S'assurer que l'Add-on est activé en allant sous ***Outils – Gestionnaire d'Add-on – VPN***, sélectionner ***Cisco AnyConnect VPN Client*** et cliquer sur ***Activer l'Add-on***.

![!!KB4832](https://cdnweb.devolutions.net/docs/docs_en_kb_KB4832.png)

### Le vpn ne démarre pas
1. S'assurer que le chemin d'installation de votre Cisco AnyConnect VPN Client est valide en allant sous ***Fichier – Paramètres – Chemins – Configurer le Chemin d'Installation – Applications – VPN***, sélectionner ***Cisco AnyConnect VPN Client*** et utiliser le bouton ellipsis pour choisir le bon chemin d'installation.
{% snippet, "badgeInfo" %}
...
1. S'assurer que la dernière version de CiscoAnyConnect est installée.
