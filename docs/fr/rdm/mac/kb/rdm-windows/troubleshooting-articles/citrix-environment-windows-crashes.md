...
1. Changer le type d'identifiants en ***Défaut***.
1. Cocher la case ***Toujours demander le mot de passe***.
...
1. Faire un clic droit sur celles-ci et sélectionner ***Modifier – Modifier (Actions Spéciales)***.
![!!KB4628](https://cdnweb.devolutions.net/docs/docs_en_kb_KB4628.png)
1. Sélectionner ***Commande Powershell Personnalisée***.
