...
1. Changer le $searchterm pour correspondre à votre recherche.
...
# obtenir un jeton pour une utilisation ultérieure en s'authentifiant avec le nom d'utilisateur/mot de passe
...
# si ($result2.SecretSummaries.length -gt 0) {
