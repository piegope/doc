---
eleventyComputed:
  title: Envoyer les journaux de session SSH Shell et les informations détaillées
---
Étapes à suivre pour collecter les journaux détaillés d'une session SSH Shell et les envoyer à l'équipe de support.
...
1. Mettre le ***Détail*** au numéro 2.
1. Sélectionner ***Événement*** comme ***Mode de journalisation***.
