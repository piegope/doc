...
1. Dans {{ fr.RDM }}, aller à ***Fichier – Paramètres – Interface utilisateur – Arborescence***.
1. Dans le champ ***Culture de l'arborescence***, spécifier une ***Étiquette de langue***.
...
3. Cliquer sur le bouton ***Vérifier*** à côté du champ ***Culture de l'arborescence***. Une fenêtre apparaîtra pour confirmer la langue et l'emplacement. Cliquer sur ***OK*** pour la fermer.
![Vérifier la culture](https://cdnweb.devolutions.net/docs/docs_en_kb_KB2111.png)

4. Cliquer sur ***OK*** dans la fenêtre ***Arborescence*** pour sauvegarder vos modifications et redémarrer {{ fr.RDM }} pour les appliquer.
