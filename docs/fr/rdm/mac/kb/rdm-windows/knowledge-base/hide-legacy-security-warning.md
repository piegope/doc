...
La sécurité héritée a été dépréciée et sera complètement supprimée à partir de la version 2023.3 de {{ fr.RDM }}. Voir [Désactiver la sécurité héritée dans {{ fr.RDM }}](/rdm/mac/kb/rdm-windows/how-to-articles/migrate-legacy-security-permissions/).
{% endsnippet %}

![Boîte d'avertissement de suppression de la sécurité héritée](https://cdnweb.devolutions.net/docs/docs_en_kb_KB6055.png)

La boîte d'avertissement ne peut pas être cachée de manière permanente de l'interface, mais une solution manuelle est disponible.
1. Fermer {{ fr.RDM }}.
...
La boîte d'avertissement de suppression de la sécurité héritée devrait maintenant être cachée.
