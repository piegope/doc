...
eleventyComputed:
  ...
  description: Comment utiliser la fonction de chargement à partir des informations système dans {{ fr.RDM }}
---
...
Cette fonction peut être trouvée en cliquant avec le bouton droit sur une entrée et en allant à ***Propriétés*** – ***Actif*** – ***Charger à partir des informations système***.
