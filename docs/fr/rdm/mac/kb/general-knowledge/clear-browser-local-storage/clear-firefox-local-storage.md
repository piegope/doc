...
![Console des outils de développement de Firefox](https://cdnweb.devolutions.net/docs/docs_en_kb_KB4865.png)
...
1. Développer la liste ***Local Storage*** située dans le menu gauche de la console.
![Console – Storage – Local Storage](https://cdnweb.devolutions.net/docs/docs_en_kb_KB4867.png)
1. Faire un clic droit sur votre ou vos site(s) et cliquer sur ***Delete All*** pour supprimer le stockage local.
