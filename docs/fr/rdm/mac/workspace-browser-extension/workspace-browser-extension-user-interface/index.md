...
eleventyComputed:
  ...
  order: 50
---
L'interface utilisateur du {{ fr.WBEX }} varie légèrement dans votre navigateur selon le produit Devolutions utilisé conjointement avec l'extension. Cette rubrique présentera l'interface utilisateur du {{ fr.WBEX }} lors de son utilisation avec {{ fr.RDMMAC }}.
...
![Sections de l'interface utilisateur](https://cdnweb.devolutions.net/docs/fr/rdm/mac/RDMMac2016.png)
...
![Sélecteur de source de données](https://cdnweb.devolutions.net/docs/fr/rdm/mac/RDMMac2015.png)

À droite du ***Menu supérieur***, le bouton ***Paramètres*** ouvre un nouvel onglet dans lequel vous pouvez configurer votre extension. Consultez la [liste complète des paramètres](/fr/rdm/mac/workspace-browser-extension/settings/).
![Bouton Paramètres](https://cdnweb.devolutions.net/docs/fr/rdm/mac/RDMMac2014.png)
...
Chaque onglet affiche une vue différente dans la ***Zone de contenu***. Les onglets disponibles lors de l'utilisation du {{ fr.WBEX }} avec {{ fr.RDMMAC }} sont :
...
Consultez [Menu latéral](/fr/rdm/mac/workspace-browser-extension/workspace-browser-extension-user-interface/side-menu/) pour obtenir davantage d'informations sur chacun des onglets.
