...
![Modèle - Pas de valeur par défaut](https://cdnweb.devolutions.net/docs/fr/rdm/mac/clip4038.png)
...
![Modèle - Modifier](https://cdnweb.devolutions.net/docs/fr/rdm/mac/clip4039.png)

Si vous souhaitez supprimer le modèle de paramètres par défaut, appuyer sur le bouton ***Supprimer***.
![Modèle - Supprimer](https://cdnweb.devolutions.net/docs/fr/rdm/mac/clip4040.png)
