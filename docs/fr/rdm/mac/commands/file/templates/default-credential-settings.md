...
![Modèle - Pas de valeur par défaut](https://cdnweb.devolutions.net/docs/fr/rdm/mac/clip0042.png)
...
![Modèle - Modifier](https://cdnweb.devolutions.net/docs/fr/rdm/mac/clip0043.png)

Si vous souhaitez supprimer le modèle de paramètres par défaut, appuyer sur le bouton ***Supprimer***.
![Modèle - Supprimer](https://cdnweb.devolutions.net/docs/fr/rdm/mac/clip0046.png)
