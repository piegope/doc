...
![Administration - Groupes d'utilisateurs](https://cdnweb.devolutions.net/docs/fr/rdm/mac/clip4128.png)
...
![Gestion du groupe d'utilisateurs - Général](https://cdnweb.devolutions.net/docs/fr/rdm/mac/clip4130.png)
...
![Gestion du groupe d'utilisateurs - Privilèges](https://cdnweb.devolutions.net/docs/fr/rdm/mac/clip4131.png)
...
![Gestion du groupe d'utilisateurs - Permissions](https://cdnweb.devolutions.net/docs/fr/rdm/mac/clip4132.png)

### Paramètres

Le menu ***Paramètres*** vous permet de définir les droits du mode hors connexion pour votre groupe d'utilisateurs.
![Gestion du groupe d'utilisateurs - Paramètres](https://cdnweb.devolutions.net/docs/fr/rdm/mac/clip4136.png)
...
![Gestion des usagers et de la sécurité - Groupes d'utilisateurs](https://cdnweb.devolutions.net/docs/fr/rdm/mac/clip4137.png)
...
![Assignation des groupes d'utilisateurs](https://cdnweb.devolutions.net/docs/fr/rdm/mac/clip4138.png)
