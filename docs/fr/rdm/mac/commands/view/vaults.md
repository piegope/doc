...
![{{ fr.VLT_MAJ }}s](https://webdevolutions.azureedge.net/docs/fr/rdm/mac/RDMMac0006.png) 
...
![Onglets {{ fr.VLT_MAJ }}s dans le {{ fr.NPANE }}](https://webdevolutions.azureedge.net/docs/fr/rdm/mac/RDMMac0007.png)
