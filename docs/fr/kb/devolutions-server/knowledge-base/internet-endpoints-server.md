...
| Azure Authentication           | https<area>://login.microsoftonline.com<br>https<area>://graph.microsoft.com   | Administration – Paramètres Serveur – Authentification |
| Okta Authentication            | https<area>://< domain >.okta.com                                              | Administration – Paramètres Serveur – Authentification |
...
| SMTP, Authentication Azure     | https<area>://graph.microsoft.com                                              | Administration – Paramètres Serveur – Courriel – Type d'authentification |
