...
### Solution 
1. Sur la console {{ fr.DVLS }} , aller dans l'onglet ***Compagnons*** et arrêter le ***Service de planification*** . 
...
1. De retour dans la console {{ fr.DVLS }} , aller dans les ***Compagnons*** pour démarrer le ***Service de planification*** .  
