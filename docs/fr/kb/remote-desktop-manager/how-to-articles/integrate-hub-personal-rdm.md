---
eleventyComputed:
  title: Intégrer Devolutions {{ fr.HUBP }} dans {{ fr.RDM }}
  description: Voici les étapes à suivre pour intégrer {{ fr.HUBP }} comme source de données dans {{ fr.RDM }}
---
Devolutions {{ fr.HUBP }} est notre solution sécurisée de gestion des mots de passe personnels pour les utilisateurs individuels — et c'est gratuit.  
...
1. Sous ***Individu***, sélectionner ***Devolutions {{ fr.HUBB }}*** et cliquer sur ***OK***.  
