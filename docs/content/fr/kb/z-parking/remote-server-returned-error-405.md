...
![!!KB4285](https://cdnweb.devolutions.net/docs/en/kb/KB4285.png)
...
![!!KB4286](https://cdnweb.devolutions.net/docs/en/kb/KB4286.png)
1. In the ***Server Roles***, uncheck the ***WebDAV Publishing role***.
![!!KB4287](https://cdnweb.devolutions.net/docs/en/kb/KB4287.png)
1. Click on the ***Remove*** button to uninstall the WebDAV Publishing role from the server.
![!!KB4288](https://cdnweb.devolutions.net/docs/en/kb/KB4288.png)
