...
![New Synchronizer entry](https://cdnweb.devolutions.net/docs/en/kb/KB8056.png)
...
![Synchronizer - Schedule](https://cdnweb.devolutions.net/docs/en/kb/KB8057.png)
1. In {{ en.RDM }}, this option can be configured in General - Schedule.
![!!KB8058](https://cdnweb.devolutions.net/docs/en/kb/KB8058.png)
