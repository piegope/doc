...
![Local Account propreties](https://cdnweb.devolutions.net/docs/en/kb/KB8086.png)
1. Go in ***Privileged Access - Providers*** on the {{ en.DVLS }} web interface to add a Windows users provider.
![Windows user provider](https://cdnweb.devolutions.net/docs/en/kb/KB8085.png)
...
![Windows user provider settings](https://cdnweb.devolutions.net/docs/en/kb/KB8087.png)
