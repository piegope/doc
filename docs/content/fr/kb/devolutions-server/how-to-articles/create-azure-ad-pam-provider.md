...
![Azure Active Directory Service](https://cdnweb.devolutions.net/docs/en/kb/KB2132.png)
1. In ***App registrations***, click on ***New registration***.
![App registrations – New registration](https://cdnweb.devolutions.net/docs/en/kb/KB2133.png)
1. Set the ***Name*** of your application.
![Register an application](https://cdnweb.devolutions.net/docs/en/kb/KB2291.png)
...
![Administration – Privileged Access – Providers – Add](https://cdnweb.devolutions.net/docs/en/kb/KB2134.png)
1. Select ***Azure AD User*** as the new PAM provider, then click ***Continue***.
![Add New PAM Provider – Azure AD User](https://cdnweb.devolutions.net/docs/en/kb/KB8065.png)
...
![Name, Description, and Password template](https://cdnweb.devolutions.net/docs/en/kb/KB2135.png)

**In the Azure Portal**

10. In the ***Overview*** of your new app registration, copy the ***Directory (tenant) ID***.
![Copy the Directory (tenant) ID](https://cdnweb.devolutions.net/docs/en/kb/KB2136.png)

**In {{ en.DVLS }}**

11. Paste the ID copied in the previous step in the ***Tenant ID*** field.
![Tenant ID](https://cdnweb.devolutions.net/docs/en/kb/KB2138.png)

**In the Azure Portal**

12. Still in the ***Overview*** of your new app registration, copy the ***Application (client) ID***.
![Copy the Application (client) ID](https://cdnweb.devolutions.net/docs/en/kb/KB2137.png)

**In {{ en.DVLS }}**

13. Paste the ID copied in the previous step in the ***Client ID*** field.
![Client ID](https://cdnweb.devolutions.net/docs/en/kb/KB2139.png)

**In the Azure Portal**

14. In ***Certificates & secrets***, click on ***Client secrets***, then on ***New client secret***.
![New client secret](https://cdnweb.devolutions.net/docs/en/kb/KB8064.png)
...
![Add a client secret](https://cdnweb.devolutions.net/docs/en/kb/KB2140.png)
1. Click ***Add***.
1. Copy the ***Value*** of this new client secret by clicking on the ***Copy to clipboard*** icon next to it.
![Copy the Client Secret Value](https://cdnweb.devolutions.net/docs/en/kb/KB8067.png)

**In {{ en.DVLS }}**

18. Paste the value copied in the previous step in the ***Secret key*** field.
![Secret key](https://cdnweb.devolutions.net/docs/en/kb/KB8068.png)
...
![API permissions – Add a permission](https://cdnweb.devolutions.net/docs/en/kb/KB2141.png)
1. In the ***Resquest API permissions*** window, select ***Microsoft Graph***.
![Microsoft Graph](https://cdnweb.devolutions.net/docs/en/kb/KB2142.png)
1. Click ***Application permissions***, then check the boxes next to the following Microsoft Graph API permissions to select them:
   ...
   * ***User.Read.All***
   ...
   ![Select API permissions](https://cdnweb.devolutions.net/docs/en/kb/KB2143.png)
...
![Remove Unnecessary Permissions](https://cdnweb.devolutions.net/docs/en/kb/KB2328.png)
...
![Grant admin consent for your organization](https://cdnweb.devolutions.net/docs/en/kb/KB2329.png)
1. To confirm that the admin consent has been granted, check the ***Status*** of your permissions.
![Granted Status](https://cdnweb.devolutions.net/docs/en/kb/KB2330.png)
...
![All roles – Helpdesk Administrator](https://cdnweb.devolutions.net/docs/en/kb/KB8072.png)
1. In ***Assignments***, click on the ***Add assignments*** button.
![Helpdesk Administrator – Add assignments](https://cdnweb.devolutions.net/docs/en/kb/KB8073.png)
1. Filter the list to find the Azure application previously created, select it, then click ***Add***.
![Add assignments](https://cdnweb.devolutions.net/docs/en/kb/KB8074.png)
...
![Scan Configuration Name](https://cdnweb.devolutions.net/docs/en/kb/KB2144.png)
...
![Scan Configuration Search mode](https://cdnweb.devolutions.net/docs/en/kb/KB8077.png)
...
![Administration – Privileged Access – Scan Configurations](https://cdnweb.devolutions.net/docs/en/kb/KB2145.png)
