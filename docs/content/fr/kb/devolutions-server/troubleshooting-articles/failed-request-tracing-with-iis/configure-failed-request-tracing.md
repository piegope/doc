...
![!!KB4327](https://cdnweb.devolutions.net/docs/en/kb/KB4327.png)
1. In ***Actions*** pane on the right, select ***Failed Requests Tracing***....
![!!KB4328](https://cdnweb.devolutions.net/docs/en/kb/KB4328.png)
...
![!!KB4329](https://cdnweb.devolutions.net/docs/en/kb/KB4329.png)
1. Expand ***Default Web Site*** and select the Web site to be traced.
![!!KB4330](https://cdnweb.devolutions.net/docs/en/kb/KB4330.png)
1. Double click on the ***Failed Request Tracing Rules*** icon of the selected Web Site.
![!!KB4331](https://cdnweb.devolutions.net/docs/en/kb/KB4331.png)
1. In the Actions pane on the right, click on ***Add***... to add a new rule.
![!!KB4332](https://cdnweb.devolutions.net/docs/en/kb/KB4332.png)
1. Select All content (*) and click ***Next***.
![!!KB4333](https://cdnweb.devolutions.net/docs/en/kb/KB4333.png)
...
![!!KB4334](https://cdnweb.devolutions.net/docs/en/kb/KB4334.png)
...
![!!KB4335](https://cdnweb.devolutions.net/docs/en/kb/KB4335.png)
1. The tracing rule is now defined.
![!!KB4336](https://cdnweb.devolutions.net/docs/en/kb/KB4336.png)
