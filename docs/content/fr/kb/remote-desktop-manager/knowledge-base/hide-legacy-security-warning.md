...
![Boîte d'avertissement de la suppression de l'ancienne sécurité](https://cdnweb.devolutions.net/docs/fr/kb/KB2090.png) 
...
![Barre de recherche Windows](https://cdnweb.devolutions.net/docs/fr/kb/KB2093.png)   
1. Naviguer jusqu'à **Devolutions\RemoteDesktopManager\RemoteDesktopManager.cfg**.
![AppData\Local\Devolutions\RemoteDesktopManager\RemoteDesktopManager.cfg](https://cdnweb.devolutions.net/docs/fr/kb/KB2091.png)  
...
1. Ajouter au fichier les lignes suivantes :
   ...
   ```  
   ![HideLegacySecurityWarning et HideMySQLWarning](https://cdnweb.devolutions.net/docs/fr/kb/KB2092.png)  
