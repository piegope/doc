...
![Invalid client ID or secret error message](https://cdnweb.devolutions.net/docs/docs_en_kb_KB2319.png)
...
![App registrations](https://cdnweb.devolutions.net/docs/docs_en_kb_KB2321.png)
...
![New client secret](https://cdnweb.devolutions.net/docs/docs_en_hub_Hub2151.png)
...
![Replace the client secret key](https://cdnweb.devolutions.net/docs/docs_en_kb_KB2323.png)
