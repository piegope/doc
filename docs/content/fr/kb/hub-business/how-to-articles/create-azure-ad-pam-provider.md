...
![Microsoft Entra ID service](https://cdnweb.devolutions.net/docs/en/kb/KB2291.png)
1. In ***App registrations***, click on ***New registration***.
![App registrations – New registration](https://cdnweb.devolutions.net/docs/en/kb/KB2292.png)
1. Set the ***Name*** of the new registration.
![Name](https://cdnweb.devolutions.net/docs/en/kb/KB2315.png)
...
![Application (client) ID and Directory (tenant) ID](https://cdnweb.devolutions.net/docs/en/kb/KB2294.png)
...
![Administration – Privileged Access – Providers – Add Provider](https://cdnweb.devolutions.net/docs/en/kb/KB2295.png)
...
![Name, Description, and Password template](https://cdnweb.devolutions.net/docs/en/kb/KB2296.png)
...
![Tenant ID and Client ID](https://cdnweb.devolutions.net/docs/en/kb/KB2297.png)
...
![New client secret](https://cdnweb.devolutions.net/docs/en/kb/KB2298.png)
1. Enter a ***Description*** and set an expiry date (or use the recommended one).
![Add a client secret](https://cdnweb.devolutions.net/docs/en/kb/KB2299.png)
1. Click ***Add***.
1. Copy the ***Value*** of your new client secret (not the ***Secret ID***).
![Client secret value](https://cdnweb.devolutions.net/docs/en/kb/KB2300.png)

**In {{ en.DHUBB }}**

5. Paste the client secret ***Value*** in the ***Secret key*** field.
![Secret key](https://cdnweb.devolutions.net/docs/en/kb/KB2301.png)
1. Click ***Add***.
...
![Add a permission](https://cdnweb.devolutions.net/docs/en/kb/KB2314.png)
1. Select ***Microsoft Graph***.
![Microsoft Graph](https://cdnweb.devolutions.net/docs/en/kb/KB2303.png)
1. Select ***Application permissions***.
![Application permissions](https://cdnweb.devolutions.net/docs/en/kb/KB2304.png)
1. Locate and check the boxes next to the following Microsoft Graph API permissions:
   * ***Group.Read.All***
   * ***RoleManagement.Read.Directory***
   * ***User.Read.All***

   ![Select permissions](https://cdnweb.devolutions.net/docs/en/kb/KB2305.png)
...
![Grant admin consent](https://cdnweb.devolutions.net/docs/en/kb/KB2306.png)
...
![Roles and administrators](https://cdnweb.devolutions.net/docs/en/kb/KB2307.png)
1. Click on ***Add assignments***.
![Add assignments](https://cdnweb.devolutions.net/docs/en/kb/KB2308.png)
1. Click on ***No member selected***.
![No member selected](https://cdnweb.devolutions.net/docs/en/kb/KB2309.png)
1. Search through the list to find the application.
1. Check the box next to the application, then click ***Select***.
![Select the application](https://cdnweb.devolutions.net/docs/en/kb/KB2310.png)
1. Click ***Next***.
![Next](https://cdnweb.devolutions.net/docs/en/kb/KB2311.png)
1. Enter a justification for the assignment, then click ***Assign***.
   ![Enter justification and Assign](https://cdnweb.devolutions.net/docs/en/kb/KB2312.png)
