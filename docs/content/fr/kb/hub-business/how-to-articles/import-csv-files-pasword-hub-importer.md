...
![CSV Import Type](https://cdnweb.devolutions.net/docs/en/kb/KB2112.png)
...
![Header Format Instruction Selection](https://cdnweb.devolutions.net/docs/en/kb/KB2114.png)
1. Click on the ellipsis button next to the ***Open CSV file*** field to select your files to import.
![Open CSV File](https://cdnweb.devolutions.net/docs/en/kb/KB2115.png)
...
![Settings and Preview](https://cdnweb.devolutions.net/docs/en/kb/KB2121.png)

7. When done, click ***Next***.
1. Under ***Mappings***, you can edit, add, or delete variables.
![Edit, Add, or Delete Variables](https://cdnweb.devolutions.net/docs/en/kb/KB2124.png)
...
![Target {{ en.VLT }} selection](https://cdnweb.devolutions.net/docs/en/kb/KB2116.png)
