...
1. Dans {{ fr.DVLS }}, aller à ***Administration – Gestion de l'accès privilégié – Fournisseurs***.
1. Cliquer sur ***Modèles {{ fr.ANYID }}***.
![Administration – Gestion de l'accès privilégié – Fournisseurs – Modèles {{ fr.ANYID }}](https://cdnweb.devolutions.net/docs/docs_en_kb_KB2173.png)
...
10. Insérer le script de l'action en le parcourant sur votre ordinateur pour le trouver ou en éditant manuellement le champ ***Script***. Vous pouvez également générer un script de base sur lequel construire.
...
![Administration – Gestion de l'accès privilégié – Fournisseurs – Ajouter](https://cdnweb.devolutions.net/docs/docs_en_kb_KB2180.png)
