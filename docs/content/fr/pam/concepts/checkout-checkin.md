...
* Manuellement
* Lorsque la session est fermée dans {{ fr.RDM }} Avec l'accès juste-à-temps (JAT), les adhésions de groupe ou de rôle des comptes privilégiés sont modifiées lors de la réservation et restaurées à leur état initial lors de la restitution.
