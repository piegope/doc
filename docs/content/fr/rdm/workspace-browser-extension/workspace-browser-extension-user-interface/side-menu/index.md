...
![Onglet Correspondant](https://cdnweb.devolutions.net/docs/fr/rdm/windows/RDMWin2085.png)
...
![Onglet du Générateur de mots de passe](https://cdnweb.devolutions.net/docs/fr/rdm/windows/RDMWin2086.png)
...
![Section Général](https://cdnweb.devolutions.net/docs/fr/rdm/windows/RDMWin2087.png)
...
![Section Avancé](https://cdnweb.devolutions.net/docs/fr/rdm/windows/RDMWin2088.png)
...
L'onglet ***À propos*** contient quelques liens et informations utiles, à savoir un lien vers notre [{{ fr.DFORUM }} de {{ fr.RDM }}](https://forum.devolutions.net/), un lien vers notre [documentation (Aide en ligne) de {{ fr.RDM }}](/fr/rdm/windows/overview/what-is-rdm/) et la version actuelle du {{ fr.WBEX }}.
![Onglet À propos](https://cdnweb.devolutions.net/docs/fr/rdm/windows/RDMWin2089.png)
