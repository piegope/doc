...
1. Dans la section ***Associations du {{ fr.WBEX }}***, cliquer sur le bouton « X » de l'entrée dans la liste, puis cliquer sur ***OK*** pour enregistrer les modifications.
...
![Supprimer une association du {{ fr.WBEX }}](https://cdnweb.devolutions.net/docs/fr/rdm/windows/Dwl4048.png)
