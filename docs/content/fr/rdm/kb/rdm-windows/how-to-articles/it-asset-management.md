...
Gestion des actifs informatiques dans {% var, "RDM" false %}.
...
4. Saisir l'URL d'un actif spécifique. ![Gestion des actifs informatiques](https://cdnweb.devolutions.net/docs/docs_en_kb_KB0058.png)
