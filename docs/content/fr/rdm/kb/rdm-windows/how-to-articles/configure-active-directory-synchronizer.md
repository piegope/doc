...
eleventyComputed:
  ...
  description: Ce sujet couvre toutes les options de l'entrée de synchroniseur d'Active Directory.
---
...
* ***Synchroniser automatiquement*** : L'entrée {{ fr.RDM }} se synchronisera automatiquement avec l'Active Directory
...
* ***Mode***
    ...
    * ***LDAP*** : Pour extraire les informations des ordinateurs Active Directory en utilisant la requête LDAP
        * ***Chemin*** : Lire plus sur cette option en cliquant sur le bouton ***Aide***
...
* ***Autre filtre*** : Lire plus sur cette option en cliquant sur le bouton ***Aide***
...
![Onglet Planification](https://cdnweb.devolutions.net/docs/RDMW6049_2024_2.png)
