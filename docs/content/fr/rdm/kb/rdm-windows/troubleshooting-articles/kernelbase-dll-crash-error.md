...
Dans certains cas, nous avons réussi à éliminer l'erreur en faisant une nouvelle installation et téléchargement depuis notre site web de l'application {{ fr.RDM }}. Veuillez suivre [Installation portable de {{ fr.RDM }}](/rdm/kb/rdm-windows/how-to-articles/portable-rdm-installation/) pour apprendre à en créer une.
