...
1. Valider que ces politiques ne sont pas cochées dans ***Aide - Diagnostic - Politique*** Si elles sont cochées, voir [Appliquer les politiques](/rdm/kb/rdm-windows/how-to-articles/group-policies/) pour les gérer.
...
2. Valider que ***Permettre la révélation du mot de passe pour l'administrateur et les utilisateurs autorisés*** est coché dans ***Administration - Paramètres système - Politique de mot de passe - Avancé***.
