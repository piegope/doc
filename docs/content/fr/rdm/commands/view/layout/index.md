...
![Section Disposition](https://cdnweb.devolutions.net/docs/fr/rdm/windows/RDMWin2027.png)

La plupart des fenêtres à onglets peuvent être déplacées et ancrées à votre guise. Cela s'applique aux styles par défaut (***Ruban*** ou ***Menu***). Pour en apprendre davantage sur cette fonction, consultez [Ancrage](/fr/rdm/windows/user-interface/customization/docking/). Le tableau ci-dessous énumère chaque option disponible dans cette section et fournit une brève description de chacune.
...
Barre d'onglets groupés
		...
		<td>
Activer/désactiver la ***Barre d'onglets groupés***. Consultez [***Barre d'onglets groupés***](/fr/rdm/windows/commands/view/layout/grouped-tab-bar/) pour plus d'informations.
		</td>
	</tr>
	<tr>
		<td>
...
Pièces jointes
		...
		<td>
Activer/désactiver le volet ***Pièces jointes***. Consultez [***Pièces jointes***](/fr/rdm/windows/commands/view/layout/attachments/) pour plus d'informations.
		</td>
	</tr>
	<tr>
		<td>
Journaux
		...
		<td>
Activer/désactiver le volet ***Journaux***. Consultez [***Journaux***](/fr/rdm/windows/commands/view/layout/logs/) pour plus d'informations.
		</td>
	</tr>
	<tr>
		<td>
Tâche
		...
		<td>
Activer/désactiver le volet ***Tâche***. Consultez [***Tâche***](/fr/rdm/windows/commands/view/layout/task/) pour plus d'informations.
		</td>
	</tr>
</table>
