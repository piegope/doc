...
![Bouton Journaux](https://cdnweb.devolutions.net/docs/fr/rdm/windows/RDMWin2028.png)
...
![Fonctionnalités Journaux](https://cdnweb.devolutions.net/docs/fr/rdm/windows/RDMWin2030.png)

### Commentaire d'enregistrement

![Insérer un commentaire d'enregistrement](https://cdnweb.devolutions.net/docs/fr/rdm/windows/RDMWin2032.png)
...
![Ajouter un commentaire aux journaux](https://cdnweb.devolutions.net/docs/fr/rdm/windows/RDMWin2031.png)

### Générer un rapport

![Générer le rapport](https://cdnweb.devolutions.net/docs/fr/rdm/windows/RDMWin2033.png)
...
![Rapport des journaux](https://cdnweb.devolutions.net/docs/fr/rdm/windows/RDMWin2034.png)
...
![Journaux](https://cdnweb.devolutions.net/docs/fr/rdm/windows/RDMWin2029.png)

Les informations concernant les entrées sont les mêmes que dans ***Journaux d'activité***, excepté ***Dossier***, ***Connexion***, ***{{ fr.VLT_MAJ }}*** et ***ID du journal de connexions*** qui ne sont pas disponibles dans ***Journaux***, puisque les informations sont spécifiques à une entrée seulement. Pour avoir une description de ces informations, consultez [***Journaux d'activités***](/fr/rdm/windows/commands/view/view/activity-logs/).
