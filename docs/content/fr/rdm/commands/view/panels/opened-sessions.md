...
![Onglet Sessions ouvertes](https://cdnweb.devolutions.net/docs/fr/rdm/windows/RDMWin2051.png)

Il est aussi situé dans la section ***Panneaux*** de l'onglet ***Affichage*** dans le ***Ruban***.
![Sessions ouvertes](https://cdnweb.devolutions.net/docs/fr/rdm/windows/RDMWin2052.png)
...
![Sessions locales ouvertes](https://cdnweb.devolutions.net/docs/fr/rdm/windows/clip11209.png)
...
![Sessions globales ouvertes](https://cdnweb.devolutions.net/docs/fr/rdm/windows/clip11210.png)
...
![Sessions locales / Sessions masquées](https://cdnweb.devolutions.net/docs/fr/rdm/windows/RdmWin2004.png)
...
![Groupes VPN](https://cdnweb.devolutions.net/docs/fr/rdm/windows/RdmWin2006.png)
...
![Différentes options d'affichage](https://cdnweb.devolutions.net/docs/fr/rdm/windows/RdmWin2005.png)
