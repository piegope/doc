...
![Recherche multi-{{ fr.VLT }}s](https://cdnweb.devolutions.net/docs/fr/rdm/windows/RDMWin2010.png)
...
![Listes déroulantes pour Recherche multi-{{ fr.VLT }}s](https://cdnweb.devolutions.net/docs/fr/rdm/windows/RDMWIN2012.png)
...
![!!RDMWin2013](https://cdnweb.devolutions.net/docs/fr/rdm/windows/RDMWin2013.png)
