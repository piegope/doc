...
![Synchroniseurs](https://cdnweb.devolutions.net/docs/fr/rdm/windows/clip11280.png)

## Est en ligne

***Est en ligne*** vous permet de vérifier et de modifier les paramètres de disponibilité en ligne de votre serveur.
![Est en ligne](https://cdnweb.devolutions.net/docs/fr/rdm/windows/clip10033.png)
