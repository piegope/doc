...
![Restaurer une copie de sauvegarde](https://cdnweb.devolutions.net/docs/fr/rdm/windows/clip10731.png)
1. Sélectionner la sauvegarde que vous souhaitez restaurer dans la liste et cliquer sur ***Sélectionner***.
![Choisir la sauvegarde](https://cdnweb.devolutions.net/docs/fr/rdm/windows/clip10732.png)
1. L'assistant de sauvegarde en ligne affiche une brève description de la sauvegarde. Cliquer sur ***Suivant***.
![Assistant de sauvegarde](https://cdnweb.devolutions.net/docs/fr/rdm/windows/clip10733.png)
...
![Restaurer la destination](https://cdnweb.devolutions.net/docs/fr/rdm/windows/clip10734.png)
