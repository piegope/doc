...
![Sauvegarde en ligne](https://cdnweb.devolutions.net/docs/fr/rdm/windows/clip10074.png)
1. Cliquer sur les points de suspension pour entrer votre ***Nom de la sauvegarde***.
![Nom de la sauvegarde](https://cdnweb.devolutions.net/docs/fr/rdm/windows/clip10729.png)
...
![Créer une nouvelle sauvegarde](https://cdnweb.devolutions.net/docs/fr/rdm/windows/clip10730.png)
