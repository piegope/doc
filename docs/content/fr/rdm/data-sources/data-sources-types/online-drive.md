...
![{{ fr.DOD }} - Général](https://cdnweb.devolutions.net/docs/fr/rdm/windows/SNAGHTML1ea82acc.PNG)
...
![{{ fr.DOD }} - Copie de sauvegarde](https://cdnweb.devolutions.net/docs/fr/rdm/windows/clip11334.png)
...
![{{ fr.DOD }} - VPN](https://cdnweb.devolutions.net/docs/fr/rdm/windows/DODVVPN.png)

### Avancé

![{{ fr.DOD }} - Avancé](https://cdnweb.devolutions.net/docs/fr/rdm/windows/clip11335.png)
