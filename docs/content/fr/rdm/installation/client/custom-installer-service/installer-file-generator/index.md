...
![Fichier – {{ fr.DA }} – Générateur de fichier de configuration](https://cdnweb.devolutions.net/docs/fr/rdm/windows/clip11248.png)
...
![Dialogue d'information de génération réussie](https://cdnweb.devolutions.net/docs/fr/rdm/windows/RDMWin2072.png)
