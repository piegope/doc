...
![Courriel d'invitation](https://cdnweb.devolutions.net/docs/fr/hub/Hub4170.png)
...
![Stockez votre clé privée](https://cdnweb.devolutions.net/docs/fr/hub/Hub4176.png)
...
1. Cliquer ***Continuer***.
![Téléchargez l'{{ fr.WAPP }}](https://cdnweb.devolutions.net/docs/fr/hub/Hub4177.png)
...
![Scannez ce code QR dans votre {{ fr.WAPP }}](https://cdnweb.devolutions.net/docs/fr/hub/Hub4178.png)
...
![Téléchargez ou imprimez votre clé privée sous la forme d'un code QR](https://cdnweb.devolutions.net/docs/fr/hub/Hub4179.png)
3. Cliquer ***Continuer***.
...
![Approbation requise](https://cdnweb.devolutions.net/docs/fr/hub/Hub4171.png)
...
![ID de l'invitation et Clé de l'invitation](https://cdnweb.devolutions.net/docs/fr/hub/Hub4172.png)
