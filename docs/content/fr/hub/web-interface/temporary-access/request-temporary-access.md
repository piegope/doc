...
![Demande d'accès temporaire](https://cdnweb.devolutions.net/docs/fr/hub/Hub6033.png)
1. Dans la fenêtre ***Demande d'accès temporaire***, sélectionner la ***Durée de l'accès*** dans la liste déroulante.
![Durée de l'accès](https://cdnweb.devolutions.net/docs/fr/hub/Hub2133.png)
...
![Permissions](https://cdnweb.devolutions.net/docs/fr/hub/Hub2134.png)
...
![Contenu des permissions](https://cdnweb.devolutions.net/docs/fr/hub/Hub2135.png)
...
![Envoyer la demande à](https://cdnweb.devolutions.net/docs/fr/hub/Hub6035.png)
...
![Rédiger un message](https://cdnweb.devolutions.net/docs/fr/hub/Hub6038.png)
...
![Courriel de confirmation](https://cdnweb.devolutions.net/docs/fr/hub/Hub2137.png)
...
![Demande d'accès temporaire approuvée](https://cdnweb.devolutions.net/docs/fr/hub/Hub6039.png)
...
![Détails et révocation de l'accès temporaire](https://cdnweb.devolutions.net/docs/fr/hub/Hub6037.png)
