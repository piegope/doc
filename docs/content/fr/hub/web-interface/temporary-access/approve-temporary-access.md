...
![Courriel de demande d'accès temporaire](https://cdnweb.devolutions.net/docs/fr/hub/Hub2140.png)

Une fois que vous êtes sur l'entrée, vous verrez une section ***Demande d'accès temporaire*** près du haut. Cliquer sur ***Afficher les détails*** ouvre la fenêtre ***Demande d'accès temporaire***, qui est décrite dans la section suivante.
![Demande d'accès temporaire à partir de l'entrée](https://cdnweb.devolutions.net/docs/fr/hub/Hub6040.png)
...
![Demande d'accès temporaire à partir du Tableau de bord](https://cdnweb.devolutions.net/docs/fr/hub/Hub6041.png)
...
![Afficher les détails](https://cdnweb.devolutions.net/docs/fr/hub/Hub2143.png)
...
![Approuver/Refuser la demande d'accès temporaire](https://cdnweb.devolutions.net/docs/fr/hub/Hub6042.png)
