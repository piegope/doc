...
![{{ en.DHUBS }} Page de bienvenue de l'assistant d'installation de {{ fr.DHUBS }}](https://cdnweb.devolutions.net/docs/HUBB2360_2024_1.png)
1. Lire et accepter les termes du ***License Agreement***, puis cliquer sur ***Next***.
![Lire et accepter les termes du License Agreement](https://cdnweb.devolutions.net/docs/HUBB2361_2024_1.png)
1. Sous ***Custom Setup***, sélectionner ***Encryption***, puis cliquer sur ***Next***.
![Installation de la fonctionnalité d'encryption](https://cdnweb.devolutions.net/docs/HUBB2362_2024_1.png)
...
![Activer le service de chiffrement et saisir l'URL](https://cdnweb.devolutions.net/docs/HUBB2366_2024_1.png)
