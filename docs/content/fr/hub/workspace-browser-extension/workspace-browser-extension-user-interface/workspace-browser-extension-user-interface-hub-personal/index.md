---
eleventyComputed:
  title: Interface utilisateur du {{ fr.WBEX }} avec {{ fr.DHUBP }}
---
L'interface utilisateur du {{ fr.WBEX }} varie légèrement dans votre navigateur selon le produit Devolutions utilisé en conjonction avec l'extension. Cette rubrique présentera l'interface utilisateur du {{ fr.WBEX }} lorsqu'elle est utilisée avec {{ fr.DHUBP }}.
...
![Sections de l'interface utilisateur](https://cdnweb.devolutions.net/docs/fr/hub/Hub2065.png)
...
![Sélecteur de source de données](https://cdnweb.devolutions.net/docs/fr/hub/Hub2066.png)
...
![Bouton Paramètres](https://cdnweb.devolutions.net/docs/fr/hub/Hub2069.png)
...
* une liste des autres compte qui ont été utilisés pour se connecter à {{ fr.DHUBP }} sur votre ordinateur;
* un bouton ***Ajouter un nouveau compte*** pour se connecter à {{ fr.DHUBP }} avec un compte qui n'est pas listé au-dessus;
* un bouton pour ***Se déconnecter*** de votre {{ fr.DA }};
* un lien vers votre {{ fr.DHUBP }};
...
![Bouton Compte](https://cdnweb.devolutions.net/docs/fr/hub/Hub2071.png)
...
![Onglets du Menu latéral](https://cdnweb.devolutions.net/docs/fr/hub/Hub2072.png)
Chaque onglet affiche une vue différente dans la ***Zone de contenu***. Les onglets disponibles lors de l'utilisation du {{ fr.WBEX }} avec {{ fr.DHUBP }} sont :
...
Consultez [Menu latéral](/fr/hub/workspace-browser-extension/workspace-browser-extension-user-interface/workspace-browser-extension-user-interface-hub-personal/side-menu/) pour obtenir davantage d'informations sur chacun des onglets.
