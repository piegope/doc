...
![Onglet du Générateur de mots de passe](https://webdevolutions.azureedge.net/docs/fr/hub/Hub2102.png) 
1. Il est maintenant possible de personnaliser les paramètres de génération du mot de passe, mais cette opération est facultative puisque les paramètres par défaut génèrent déjà des mots de passe très forts. Cela dit, il peut être nécessaire d'ajuster les paramètres pour répondre aux exigences spécifiques de certains sites Web. Si vous ne souhaitez pas personnaliser les paramètres de génération, vous pouvez passer à l'<a href="#5">étape 5</a>. 
    ...
    ![Longueur du mot de passe](https://webdevolutions.azureedge.net/docs/fr/hub/Hub2103.png) 
    ...
    ![Paramètres généraux](https://webdevolutions.azureedge.net/docs/fr/hub/Hub2104.png) 
    ...
    ![Paramètres avancés](https://webdevolutions.azureedge.net/docs/fr/hub/Hub2105.png) 
...
![Générer un mot de passe](https://webdevolutions.azureedge.net/docs/fr/hub/Hub2106.png) 
1. Cliquer sur le bouton ***Copier dans le presse-papiers*** pour copier le mot de passe.  
![Copier dans le presse-papiers](https://webdevolutions.azureedge.net/docs/fr/hub/Hub2107.png)  
...
![Ajouter un site Web](https://webdevolutions.azureedge.net/docs/fr/hub/Hub2108.png) 
