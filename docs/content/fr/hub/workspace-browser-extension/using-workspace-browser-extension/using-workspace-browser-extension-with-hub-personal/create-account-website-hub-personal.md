---
eleventyComputed:
  title: Créer un compte de site Web dans {{ fr.DHUBP }} avec le {{ fr.WBEX }}
  order: 10
---
...
Si vous avez déjà un compte pour le site Web, apprenez plutôt comment [Ajouter une entrée avec le {{ fr.WBEX }}](/fr/hub/workspace-browser-extension/using-workspace-browser-extension/using-workspace-browser-extension-with-hub-personal/add-entry-hub-personal-workspace-browser-extension/).
{% endsnippet %}

Suivez les étapes ci-dessous pour créer un compte de site Web avec le {{ fr.WBEX }} et sauvegarder vos identifiants dans {{ fr.DHUBP }}.
...
![Page d'enregistrement](https://cdnweb.devolutions.net/docs/fr/hub/Hub2093.png)
...
![Onglet du Générateur de mots de passe](https://cdnweb.devolutions.net/docs/fr/hub/Hub2102.png)
1. Il est maintenant possible de personnaliser les paramètres de génération du mot de passe, mais cette opération est facultative puisque les paramètres par défaut génèrent déjà des mots de passe très forts. Cela dit, il peut être nécessaire d'ajuster les paramètres pour répondre aux exigences spécifiques de certains sites Web. Si vous ne souhaitez pas personnaliser les paramètres de génération, vous pouvez passer à l'<a href="#5">étape 5</a>.
    ...
    ![Longueur du mot de passe](https://cdnweb.devolutions.net/docs/fr/hub/Hub2103.png)
    ...
    ![Paramètres généraux](https://cdnweb.devolutions.net/docs/fr/hub/Hub2104.png)
    ...
    ![Paramètres avancés](https://cdnweb.devolutions.net/docs/fr/hub/Hub2105.png)
...
![Générer un mot de passe](https://cdnweb.devolutions.net/docs/fr/hub/Hub2106.png)
1. Cliquer sur le bouton ***Copier dans le presse-papiers*** pour copier le mot de passe.
![Copier dans le presse-papiers](https://cdnweb.devolutions.net/docs/fr/hub/Hub2107.png)
1. Coller le mot de passe dans le champ du site Web correspondant.
![Coller le mot de passe](https://cdnweb.devolutions.net/docs/fr/hub/Hub2100.png)
...
![Ajouter un site Web](https://cdnweb.devolutions.net/docs/fr/hub/Hub2108.png)
