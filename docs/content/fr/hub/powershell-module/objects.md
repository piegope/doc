...
Boolean 
		...
		<td>
Indique si vous voulez autoriser le {{ fr.UVLT }} dans {{ fr.DHUB }}. 
		</td>
	</tr>
	<tr>
		<td>
...
Enum(HubDisableReason) 
		...
		<td>
LectureSeulement - Énumération qui montre la raison de la désactivation du hub. 
		</td>
	</tr>
	<tr>
		<td>
...
Array of Object(NetworkFilter) 
		...
		<td>
Tableau d'objet NetworkFilter qui gère le filtrage IpAddress vers {{ fr.DHUB }}. 
		</td>
	</tr>
	<tr>
		<td>
...
Guid 
		...
		<td>
Identifiant d'un modèle de mot de passe que vous voulez définir et activer dans {{ fr.DHUB }}. 
		</td>
	</tr>
	<tr>
		<td>
...
Boolean 
		...
		<td>
Indicateur qui gère si les utilisateurs peuvent accéder au hub en mode hors ligne dans {{ fr.RDM }}. 
		</td>
	</tr>
	<tr>
		<td>
