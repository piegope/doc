...
![Exécuter en tant qu'administrateur](https://cdnweb.devolutions.net/docs/fr/server/ServerOp8139.png)
...
![Déployer un nouveau {{ fr.DVLS }}](https://cdnweb.devolutions.net/docs/fr/server/ServerOp8048.png)
...
![Vérification des conditions préalables à IIS pour l'installation](https://cdnweb.devolutions.net/docs/fr/server/ServerOp8049.png)
1. Cocher la case ***J'accepte les termes de la convention de licence***, puis cliquer sur ***Suivant***.
![Convention de licence {{ fr.DVLS }}](https://cdnweb.devolutions.net/docs/fr/server/ServerOp8050.png)
...
![Assistant de déploiement {{ fr.DVLS }}](https://cdnweb.devolutions.net/docs/fr/server/ServerOp8054.png)
...
![Assistant d'installation de {{ fr.DVLS }}](https://cdnweb.devolutions.net/docs/fr/server/ServerOp8051.png)
...
![Source et Destination de l'installation](https://cdnweb.devolutions.net/docs/fr/server/ServerOp8053.png)
...
![Copie de sauvegarde des clés de chiffrement](https://cdnweb.devolutions.net/docs/fr/server/ServerOp4019.png)
...
![Mot de passe de la {{ fr.DVLSCONSOLE }}](https://cdnweb.devolutions.net/docs/fr/server/ServerOp8138.png)
...
![Service de planification](https://cdnweb.devolutions.net/docs/fr/server/ServerOp8055.png)
1. En choisissant de ne pas installer le planificateur, vous obtiendrez le message d'avertissement suivant.
![Avertissement du planificateur](https://cdnweb.devolutions.net/docs/fr/server/ServerOp8056.png)
1. Sous ***Résumé***, valider la configuration et cliquer sur ***Installer***.
![Fenêtre de progression de l'installation](https://cdnweb.devolutions.net/docs/fr/server/ServerOp8057.png)

Une fois l'installation terminée, un récapitulatif indique si {{ fr.DVLS }} a été déployé correctement.
![Résumé](https://cdnweb.devolutions.net/docs/fr/server/ServerOp8059.png)
