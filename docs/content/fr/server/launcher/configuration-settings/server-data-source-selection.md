...
1. Choisir ***{{ fr.DVLS }}***. 
![!!ServerOp4005](https://webdevolutions.azureedge.net/docs/fr/server/ServerOp4005.png) 
1. Dans le champ ***Hôte*** entrer l'adresse Web {{ fr.DVLS }} et remplir vos identifiants. 
![!!ServerOp4006](https://webdevolutions.azureedge.net/docs/fr/server/ServerOp4006.png) 
