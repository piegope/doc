...
![Page de connexion](https://cdnweb.devolutions.net/docs/fr/server/ServerOp2031.png)
...
![Ajouter un site Web](https://cdnweb.devolutions.net/docs/fr/server/ServerOp2032.png)
...
![Bouton Ajouter un site Web](https://cdnweb.devolutions.net/docs/fr/server/ServerOp2033.png)
