...
![{{ en.DVLS }} setup](https://cdnweb.devolutions.net/docs/en/server/ServerOp2076.png)
...
![{{ en.DVLS }} URL](https://cdnweb.devolutions.net/docs/en/server/ServerOp2077.png)
1. Choose your authentication method, then log in using your corresponding credentials.
![Authentication](https://cdnweb.devolutions.net/docs/en/server/ServerOp2078.png)
...
![Security settings](https://cdnweb.devolutions.net/docs/en/server/ServerOp2079.png)
