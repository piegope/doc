...
![{{ en.DVLS }} setup](https://cdnweb.devolutions.net/docs/en/server/ServerOp2080.png)
...
![{{ en.DVLS }} URL](https://cdnweb.devolutions.net/docs/en/server/ServerOp2081.png)
1. Choose to use a biometric lock (Windows Hello, Touch ID, etc.) or a master password.
![Security settings](https://cdnweb.devolutions.net/docs/en/server/ServerOp2082.png)
