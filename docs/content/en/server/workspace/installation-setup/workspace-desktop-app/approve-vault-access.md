...
![Messages](https://cdnweb.devolutions.net/docs/en/server/DVLS6015_2024_1.png)

 ***Temporary access requests*** are listed as shown below. 

![Temporary access requests](https://cdnweb.devolutions.net/docs/en/server/DVLS6016_2024_1.png)
...
![Details of the request](https://cdnweb.devolutions.net/docs/en/server/DVLS6017_2024_1.png)

This view is divided into two sections:

* The ***Request Info*** section contains information about the user's request.

![Info section](https://cdnweb.devolutions.net/docs/en/server/DVLS6014_2024_1.png)
...
![Response Parameters](https://cdnweb.devolutions.net/docs/en/server/DVLS6018_2024_1.png)
