...
![Companions tab](https://cdnweb.devolutions.net/docs/en/server/ServerOp2083.png)
1. In the {{ en.DGW }} section, click on ***Install***.
1. Choose ***Side-by-side Installation***.
![Side-by-side](https://cdnweb.devolutions.net/docs/en/server/ServerOp0004.png)
...
1. Click ***OK***.
![OK Button](https://cdnweb.devolutions.net/docs/en/server/ServerOp0005.png)
1. Go to the {{ en.DVLS }} web interface, connect with an administrator account.
1. Go to ***Administration – {{ en.DGW }}***.
![{{ en.DGW }}](https://cdnweb.devolutions.net/docs/en/server/ServerOp0006.png)
...
![Ping](https://cdnweb.devolutions.net/docs/en/server/ServerOp0007.png)
...
1. From the {{ en.DVLSCONSOLE }}, click on the ***Companions*** tab.
![Companions Tab](https://cdnweb.devolutions.net/docs/en/server/ServerOp0018.png)
1. In the {{ en.DGW }} section, click on ***Install***.
1. Choose ***Standalone Installation***.
![Standalone](https://cdnweb.devolutions.net/docs/en/server/ServerOp0008.png)
...
1. Click ***Next***.
![Download version or msi file](https://cdnweb.devolutions.net/docs/en/server/ServerOp0009.png)
1. Enter the ***Access URI*** information, for example https://gateway.example.com.
![Listeners](https://cdnweb.devolutions.net/docs/en/server/ServerOp0023.png)
...
![Download public key](https://cdnweb.devolutions.net/docs/en/server/ServerOp0016.png)
1. Click ***Next***.
![Key Pair Configuration](https://cdnweb.devolutions.net/docs/en/server/ServerOp0011.png)
1. Click ***Install***.
![Summary](https://cdnweb.devolutions.net/docs/en/server/ServerOp0012.png)
1. Click ***Close***.
![Installation Summary](https://cdnweb.devolutions.net/docs/en/server/ServerOp0013.png)
1. On the {{ en.DVLS }} web interface, connect with an administrator account.
1. Go to ***Administration – {{ en.DGW }}***.
![{{ en.DGW }}](https://cdnweb.devolutions.net/docs/en/server/ServerOp0006.png)
1. Click on the ***Add*** button on the top right corner.
![Add Button](https://cdnweb.devolutions.net/docs/en/server/ServerOp0014.png)
...
1. Click on ***Save***.
![{{ en.DGW }} Information](https://cdnweb.devolutions.net/docs/en/server/ServerOp0015.png)
