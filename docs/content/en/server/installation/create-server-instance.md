...
1. Under ***General***, enter a custom ***Name*** and ***Description***. Under ***Serial***, provide a license serial that has been received by email upon buying the product. If you did not buy any {{ en.DVLS }} license yet, you may [Request a 30-days trial](https://server.devolutions.net/trial) or continue without a license to use Devolutions Server Free for up to 10 users. You will be prompted on Devolutions Server first launch to ***Activate the Free Version***.
