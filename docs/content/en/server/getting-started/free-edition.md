...
eleventyComputed:
  title: Free edition
  description: Install {{ en.DVLSCONSOLE }} on the web server. It is available from the [Download](https://server.devolutions.net/home/download) page.
---
...
1. Under ***General***, enter a custom ***Name*** and ***Description***. You will be prompted on {{ en.DVLS }} first launch to ***Activate the Free Version*** to use {{ en.DVLS }} Free for up to ***10 users***.
