...
---
Configuring ***offline mode*** allows users or groups to access resources without needing continuous internet connection using a {{ en.DVLS }} data source in {% var, "RDM" false %}.
