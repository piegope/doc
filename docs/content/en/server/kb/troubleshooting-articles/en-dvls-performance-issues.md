...
eleventyComputed:
  ...
  keywords:
---
{{ variables.DVLS.en }} performance issues [service@devolutions.net](mailto:service@devolutions.net).

**Disk usage by Top Tables** report from **SQL Server Management Studio (SSMS)** to assess the number of records in certain database tables.

**Right click - Reports - Standard Reports - Disk Usage by Top Tables**
