...
![First login](https://cdnweb.devolutions.net/docs/en/server/Dwl4016.png)
...
![Server Address](https://cdnweb.devolutions.net/docs/en/server/Dwl4017.png)
1. ***Log In*** to your account.
![{{ en.WBEX }} Login](https://cdnweb.devolutions.net/docs/en/server/Dwl4018.png)
1. Enter your {{ en.DVLS }} credentials and click ***Log In***.
![{{ en.DVLS }} Login](https://cdnweb.devolutions.net/docs/en/server/Dwl4019.png)
...
![Successful Association of {{ en.DVLS }} to the {{ en.WBEX }}](https://cdnweb.devolutions.net/docs/en/server/Dwl4048.png)
1. To select the {{ en.VLT }}s to be synchronized, click on the ***{{ en.VLT_MAJ }}s*** tab, then click the ***Select {{ en.VLT }}s to Sync*** button.
![{{ en.VLT_MAJ }}s tab](https://cdnweb.devolutions.net/docs/en/server/Dwl4020.png)
1. Click on ***Select All*** or individually check the {{ en.VLT }}s to synchronize.
![Selection of {{ en.VLT }}s to be Synchronized](https://cdnweb.devolutions.net/docs/en/server/ServerOp2014.png)
...
![Synchronized {{ en.VLT }}s](https://cdnweb.devolutions.net/docs/en/server/Dwl4055.png)
