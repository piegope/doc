...
![Registration Page](https://cdnweb.devolutions.net/docs/en/server/ServerOp2000.png)
...
![Password Generator Tab](https://cdnweb.devolutions.net/docs/en/server/ServerOp2001.png)
...
![Password length](https://cdnweb.devolutions.net/docs/en/server/ServerOp2002.png)
{type="a"}
...
![General Settings](https://cdnweb.devolutions.net/docs/en/server/ServerOp2003.png)
...
![Advanced Settings](https://cdnweb.devolutions.net/docs/en/server/ServerOp2004.png)
...
![Generate Password](https://cdnweb.devolutions.net/docs/en/server/ServerOp2005.png)
1. Click on the ***Copy to Clipboard*** button to copy the password.
![Copy to Clipboard](https://cdnweb.devolutions.net/docs/en/server/ServerOp2006.png)
1. Paste your password in the website’s corresponding field.
![Paste Password](https://cdnweb.devolutions.net/docs/en/server/ServerOp2007.png)
...
![Add Website](https://cdnweb.devolutions.net/docs/en/server/ServerOp2008.png)
