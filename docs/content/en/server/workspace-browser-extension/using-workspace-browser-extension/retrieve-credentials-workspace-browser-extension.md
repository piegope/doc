...
![Settings Icon](https://cdnweb.devolutions.net/docs/en/server/ServerOp2015.png)
1. Click on ***General*** in the ***Configuration*** section.
![Settings – Configuration – General](https://cdnweb.devolutions.net/docs/en/server/ServerOp2016.png)
1. In the ***General*** tab, the ***Show icon in fields*** setting should be enabled by default. If not, check the box next to the option to enable it.
   ...
   ![General – Show icon in fields](https://cdnweb.devolutions.net/docs/en/server/ServerOp2017.png)

4. Click ***Save***.
5. Click on ***{{ en.DVLS }}*** in the ***Data sources*** section.
![Settings – Data sources – {{ en.DVLS }}](https://cdnweb.devolutions.net/docs/en/server/ServerOp2018.png)
...
![Actions – Automatically retrieve and fill in credentials on load](https://cdnweb.devolutions.net/docs/en/server/ServerOp2019.png)
   {% snippet icon.badgeInfo %}
...
1. Go to the login page of the website. This page will be different for each website; this section will use the Atlassian website as an example. One of two scenarios can happen:
  ...
  ![Automatically Filled Credentials Fields](https://cdnweb.devolutions.net/docs/en/server/ServerOp2024.png)
  ...
  ![Entry Filter and Selection](https://cdnweb.devolutions.net/docs/en/server/ServerOp2021.png)
...
1. Click on the website entry that contains the credentials for this website. If multiple entries are available, you can use the ***Filter*** bar to find the one you need.
   ...
   ![Entry Selection](https://cdnweb.devolutions.net/docs/en/server/ServerOp2022.png)
...
![Credentials Transfer in Corresponding Fields](https://cdnweb.devolutions.net/docs/en/server/ServerOp2023.png)
