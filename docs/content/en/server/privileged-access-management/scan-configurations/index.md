...
![Account Discovery dialog](https://cdnweb.devolutions.net/docs/en/server/ServerOp8143.png)
...
![!!ServerOp8096](https://cdnweb.devolutions.net/docs/en/server/ServerOp8096.png)

To see the results of the discovery process, click on the eye icon of the Account Discovery to see the list of accounts.
![Account Discovery results dialog](https://cdnweb.devolutions.net/docs/en/server/ServerOp8147.png)
...
![Import Selected Accounts operation](https://cdnweb.devolutions.net/docs/en/server/ServerOp8148.png)
...
![Import Window](https://cdnweb.devolutions.net/docs/en/server/ServerOp8149.png)
