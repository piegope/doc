...
![Providers dashboard](https://cdnweb.devolutions.net/docs/en/server/ServerOp8140.png)
...
![Managed providers](https://cdnweb.devolutions.net/docs/en/server/ServerOp2107.png)
...
![Unmanaged providers](https://cdnweb.devolutions.net/docs/en/server/ServerOp2108.png)

* ***AnyIdentity*** providers:
    * Windows accounts
    * Windows local accounts

![AnyIdentity providers](https://cdnweb.devolutions.net/docs/en/server/ServerOp2109.png)
