...
![Propagation (Preview)](https://cdnweb.devolutions.net/docs/en/kb/KB0096.png)
1. Click on ***Script Templates***.
![Script Templates](https://cdnweb.devolutions.net/docs/en/kb/KB0097.png)
1. Click on ***Import***.
![Import](https://cdnweb.devolutions.net/docs/en/kb/KB0098.png)
1. Select the previously downloaded template .json file and click ***Import***.
![Import button](https://cdnweb.devolutions.net/docs/en/kb/KB0099.png)
1. Click ***Save***.
![Save button](https://cdnweb.devolutions.net/docs/en/kb/KB0100.png)
1. Go back to the ***Propagation (Preview)*** page.
1. Click on ***Add***.
![Add](https://cdnweb.devolutions.net/docs/en/kb/KB0101.png)
1. Select the desired template and click on ***Select***.
![Select button](https://cdnweb.devolutions.net/docs/en/kb/KB0102.png)
...
![Configure a PAM entry](https://cdnweb.devolutions.net/docs/en/kb/KB0103.png)
1. Click on ***Continue***.
...
![Save button](https://cdnweb.devolutions.net/docs/en/kb/KB0104.png)
...
![+ button](https://cdnweb.devolutions.net/docs/en/kb/KB0105.png)
1. Select the configuration to link to that account, and click ***Confirm***.
![Confirm button](https://cdnweb.devolutions.net/docs/en/kb/KB0106.png)
   {% snippet icon.badgeInfo %}
   It is possible to select multiple configurations.
   {% endsnippet %}

1. Click ***OK*** to save the changes and close the window.
![OK button](https://cdnweb.devolutions.net/docs/en/kb/KB0107.png)
   {% snippet icon.badgeInfo %}
...
![Script Templates](https://cdnweb.devolutions.net/docs/en/kb/KB0097.png)
1. Click on ***Add***.
![Add](https://cdnweb.devolutions.net/docs/en/kb/KB0112.png)
...
![Propagation Properties](https://cdnweb.devolutions.net/docs/en/kb/KB0113.png)
...
![Property Mapping](https://cdnweb.devolutions.net/docs/en/kb/KB0114.png)
...
![Generate base script](https://cdnweb.devolutions.net/docs/en/kb/KB0115.png)
   {% snippet icon.badgeInfo %}
