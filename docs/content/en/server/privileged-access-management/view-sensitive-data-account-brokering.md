...
![With Access](https://cdnweb.devolutions.net/docs/en/server/ServerOp2119.png)
![Without access](https://cdnweb.devolutions.net/docs/en/server/ServerOp2120.png)
...
![Credential Brokering Checkout Request](https://cdnweb.devolutions.net/docs/en/server/ServerOp2121.png)
