...
![PAM license](https://cdnweb.devolutions.net/docs/en/server/ServerOp2104.png)
...
![Administration – Privileged Access – Default settings](https://cdnweb.devolutions.net/docs/en/server/ServerOp2105.png)
...
![Administration – System permissions – Modules – Privileged access](https://cdnweb.devolutions.net/docs/en/server/ServerOp2106.png)
...
![Managed PAM providers](https://cdnweb.devolutions.net/docs/en/server/ServerOp2107.png)
![Password reset only PAM providers](https://cdnweb.devolutions.net/docs/en/server/ServerOp2108.png)
![AnyIdentity PAM providers](https://cdnweb.devolutions.net/docs/en/server/ServerOp2109.png)
When adding the provider, make sure to enable the ***Add PAM {{ en.VLT }}*** and ***Add Scan Configuration*** options under ***Actions***.
![PAM provider configuration](https://cdnweb.devolutions.net/docs/en/server/ServerOp2110.png)
...
1. Click ***OK***.
![PAM Scan configuration](https://cdnweb.devolutions.net/docs/en/server/ServerOp2111.png)
...
![PAM {{ en.VLT }}s](https://cdnweb.devolutions.net/docs/en/server/ServerOp2112.png)
...
![View results](https://cdnweb.devolutions.net/docs/en/server/ServerOp2113.png)
1. Select all the accounts you wish to import. Then, click ***Import Selected Accounts***.
![Import selected accounts](https://cdnweb.devolutions.net/docs/en/server/ServerOp2114.png)
...
![Import accounts](https://cdnweb.devolutions.net/docs/en/server/ServerOp2115.png)
...
![PAM Account Sync Check](https://cdnweb.devolutions.net/docs/en/server/ServerOp2116.png)
