...
Use our ***user group-based access control*** to grant permissions in a granular fashion. Advanced logging of all user activity is included to offer visibility in all aspects of the solution.
...
| ![!!clip10056](https://cdnweb.devolutions.net/docs/docs_en_server_clip10056.png)<br><br>**Web-based {{ en.VLT }}**<br><br>Web browser access and [{{ en.WBEX }}](/server/workspace-browser-extension/overview/) | ![!!Application64x64](https://cdnweb.devolutions.net/docs/docs_common_Application64x64.png)<br><br>**Session management**<br><br>Using a client application (desktop or mobile) |
| --- | --- |
...
| Remote access technologies such as RDP, SSH, and Active Directory web console are supported within the web interface through {{ en.DGW }}. | Unlike with web browser access, {{ en.RDM }} can launch a wide range of sessions using remote access technologies. |

## Highlights

| ![!!clip10054](https://cdnweb.devolutions.net/docs/docs_en_server_clip10054.png)<br><br>**High-end server** | ![!!clip10055](https://cdnweb.devolutions.net/docs/docs_en_server_clip10055.png)<br><br>**Full Active Directory (AD) integration** | ![!!clip10057](https://cdnweb.devolutions.net/docs/docs_en_server_clip10057.png)<br><br>Web architecture |
| --- | --- | --- |
| Self-hosted locally on an application server or a private cloud. Store entries in an unlimited number of {{ en.VLT }}s and manage access to these entries with our ***user group-based access control***. | Users accessing the system will be granted permissions based on their membership in specific AD groups, making user management almost seamless for organizations that use AD to manage teams. | Implemented using a Web architecture so it can exposed publicly on the Internet or only to your Intranet or private cloud. |

| ![!!clip10050](https://cdnweb.devolutions.net/docs/docs_en_server_clip10050.png)<br><br>**Multi-factor authentication** | ![!!clip10062](https://cdnweb.devolutions.net/docs/docs_en_server_clip10062.png)<br><br>**Email notifications** | ![!!clip10060](https://cdnweb.devolutions.net/docs/docs_en_server_clip10060.png)<br><br>**IP restrictions** |
| --- | --- | --- |
