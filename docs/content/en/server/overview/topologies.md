...
![Single server installation](https://cdnweb.devolutions.net/docs/en/server/RecommendedTopology-1.png)
...
![Basic topology](https://cdnweb.devolutions.net/docs/en/server/RecommendedTopology-2.png)
...
![High-availability topology](https://cdnweb.devolutions.net/docs/en/server/RecommendedTopology-3.png)
...
![Load-balancing {{ en.DVLS }} topology](https://cdnweb.devolutions.net/docs/en/server/RecommendedTopology-4.png)
...
![Manual failover with two {{ en.DVLS }}s](https://cdnweb.devolutions.net/docs/en/server/RecommendedTopology-5.png)
