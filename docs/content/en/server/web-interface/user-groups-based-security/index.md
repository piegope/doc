...
![Create a User Group](https://cdnweb.devolutions.net/docs/docs_en_server_clip8034.png)
...
![Configure a User Group](https://cdnweb.devolutions.net/docs/docs_en_server_clip8035.png)
...
![Assign a user to the User Group](https://cdnweb.devolutions.net/docs/docs_en_server_clip8036.png)
...
![Create a user](https://cdnweb.devolutions.net/docs/docs_en_server_clip8037.png)
...
![!!ServerOp4010](https://cdnweb.devolutions.net/docs/docs_en_server_ServerOp4010.png)
...
![Administrator user](https://cdnweb.devolutions.net/docs/docs_en_server_clip8039.png)
...
![Restricted user](https://cdnweb.devolutions.net/docs/docs_en_server_clip8040.png)
...
![Entry's Permissions](https://cdnweb.devolutions.net/docs/docs_en_server_clip8042.png)
...
![Root Permissions](https://cdnweb.devolutions.net/docs/docs_en_server_clip8043.png)
