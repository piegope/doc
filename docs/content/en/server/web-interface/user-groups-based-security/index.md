...
![Create a User Group](https://cdnweb.devolutions.net/docs/en/server/clip8034.png)
...
![Configure a User Group](https://cdnweb.devolutions.net/docs/en/server/clip8035.png)
...
![Assign a user to the User Group](https://cdnweb.devolutions.net/docs/en/server/clip8036.png)
...
![Create a user](https://cdnweb.devolutions.net/docs/en/server/clip8037.png)
...
![!!ServerOp4010](https://cdnweb.devolutions.net/docs/en/server/ServerOp4010.png)
...
![Administrator user](https://cdnweb.devolutions.net/docs/en/server/clip8039.png)
...
![Restricted user](https://cdnweb.devolutions.net/docs/en/server/clip8040.png)
...
![Entry's Permissions](https://cdnweb.devolutions.net/docs/en/server/clip8042.png)
...
![Root Permissions](https://cdnweb.devolutions.net/docs/en/server/clip8043.png)
...
![Sample Structure](https://cdnweb.devolutions.net/docs/en/server/clip8044.png)
...
![Permissions Structure](https://cdnweb.devolutions.net/docs/en/server/clip8045.png)
