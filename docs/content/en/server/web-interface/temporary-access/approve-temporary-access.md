...
![Pending access requests](https://cdnweb.devolutions.net/docs/en/server/ServerOp6052.png)
...
![Temporary Access Requests Report](https://cdnweb.devolutions.net/docs/en/server/ServerOp6049.png)
...
![Temporary Access Request](https://cdnweb.devolutions.net/docs/en/server/ServerOp6050.png)
...
![Pending Access Requests](https://cdnweb.devolutions.net/docs/en/server/ServerOp6048.png)
...
![Temporary Access Response](https://cdnweb.devolutions.net/docs/en/server/ServerOp6037.png)
