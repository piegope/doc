...
![Reports](https://cdnweb.devolutions.net/docs/docs_en_server_ServerOp6084.png)
...
![Filtering and Sorting Reports](https://cdnweb.devolutions.net/docs/docs_en_server_ServerOp8028.png)

Select a preset time interval or create a custom timeline on which the report will be based on.

![Time interval button](https://cdnweb.devolutions.net/docs/docs_en_server_clip10367.png)
