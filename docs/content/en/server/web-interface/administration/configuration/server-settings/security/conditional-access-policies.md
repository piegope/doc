...
![Administration – Configuration – Server Settings](https://cdnweb.devolutions.net/docs/en/server/ServerOp6004.png)

2. Click on ***Conditional Access Policies*** under ***Security***.

![Security – Conditional Access Policies](https://cdnweb.devolutions.net/docs/en/server/ServerOp6005.png)

## Configure Login from the web interface

1. Select ***Login*** in the ***Target*** drop-down menu and click on the plus button (***Add***).

![Target drop-down menu and plus button](https://cdnweb.devolutions.net/docs/en/server/ServerOp6023.png)
...
![Action when matched and Action when not matched menus](https://cdnweb.devolutions.net/docs/en/server/ServerOp6019.png)

3. Click on the plus button (***Add***) in the ***Rules*** section.

![Rules section](https://cdnweb.devolutions.net/docs/en/server/ServerOp6015.png)
...
![Rules section](https://cdnweb.devolutions.net/docs/en/server/ServerOp6006.png)

5. Click ***Add*** to close the window.

6. Select ***All*** or ***Any*** under ***Rules – Rule validation***.

![Rules – Rule validation](https://cdnweb.devolutions.net/docs/en/server/ServerOp6017.png)
...
![Is Active](https://cdnweb.devolutions.net/docs/en/server/ServerOp6020.png)
...
![Default action when no policy matches](https://cdnweb.devolutions.net/docs/en/server/ServerOp6003.png)
...
![Send reset email to & Specific email](https://cdnweb.devolutions.net/docs/en/server/ServerOp2064.png)
...
![Supported MFA](https://cdnweb.devolutions.net/docs/en/server/ServerOp2065.png)
...
![Default and Alternate MFA](https://cdnweb.devolutions.net/docs/en/server/ServerOp2066.png)
1. Click ***Save***.
...
![Target drop-down menu and plus button](https://cdnweb.devolutions.net/docs/en/server/ServerOp6025.png)
...
![Action when matched and Action when not matched menus](https://cdnweb.devolutions.net/docs/en/server/ServerOp6026.png)
