...
![Administration – Configuration – System Images](https://cdnweb.devolutions.net/docs/en/server/ServerOp6059.png)
1. Click ***Add (+)*** in the right corner.
 ![Administration – System Images – Add (+)](https://cdnweb.devolutions.net/docs/en/server/ServerOp6061.png)
...
1. Click ***Upload*** to close the window and save the image.
 ![Insert Image File window](https://cdnweb.devolutions.net/docs/en/server/ServerOp6062.png)
Information relevant to the image is presented in tabular form.
 ![Administration – System Images](https://cdnweb.devolutions.net/docs/en/server/ServerOp6058.png)
