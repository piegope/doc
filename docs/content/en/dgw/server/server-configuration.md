...
This method supports more sessions if there is an available {{ en.DGW }} license(s). This installation process is the easier of the two and is the recommended method for simpler network layouts.
...
1. Click ***OK***.
![OK Button](https://cdnweb.devolutions.net/docs/docs_en_server_ServerOp0005.png)
1. Go to the {{ en.DVLS }} web interface, connect with an administrator account.
1. Go to ***Administration – {{ en.DGW }}***.
![{{ en.DGW }}](https://cdnweb.devolutions.net/docs/docs_en_server_ServerOp0006.png)
...
1. From the {{ en.DVLSCONSOLE }}, click on the ***Companions*** tab.
![Companions Tab](https://cdnweb.devolutions.net/docs/docs_en_server_ServerOp0018.png)
1. In the {{ en.DGW }} section, click on ***Install***.
...
1. Click ***Next***.
![Download version or msi file](https://cdnweb.devolutions.net/docs/docs_en_server_ServerOp0009.png)
...
![Download public key](https://cdnweb.devolutions.net/docs/docs_en_server_ServerOp0016.png)
1. Click ***Next***.
...
![Add Button](https://cdnweb.devolutions.net/docs/docs_en_server_ServerOp0014.png)
...
1. Click on ***Save***.
![{{ en.DGW }} Information](https://cdnweb.devolutions.net/docs/docs_en_server_ServerOp0015.png)
