---
eleventyComputed:
  title: "{{ en.WMAPP }} installation with {{ en.DHUBB }}"
...
![Email address](https://cdnweb.devolutions.net/docs/docs_en_hub_Hub2211.png)
1. Log in using your {{ en.DA }} password, then tap ***Continue***.
![{{ en.DA }} login](https://cdnweb.devolutions.net/docs/docs_en_hub_Hub2212.png)
1. Select the hub you want to connect to, then tap ***Next***.
![Hub selection](https://cdnweb.devolutions.net/docs/docs_en_hub_Hub2213.png)
...
1. Choose ***{{ en.DHUBB }}***.
1. Click ***Next***.
![Choose your authentication method](https://cdnweb.devolutions.net/docs/docs_en_hub_Hub6105.png)
