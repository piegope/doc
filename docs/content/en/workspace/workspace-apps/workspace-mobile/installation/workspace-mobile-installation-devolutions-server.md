---
eleventyComputed:
  title: "{{ en.WMAPP }} installation with {{ en.DVLS }}"
...
![{{ en.DVLS }} URL](https://cdnweb.devolutions.net/docs/docs_en_server_ServerOp2077.png)
1. Choose your authentication method, then log in using your corresponding credentials.
![Authentication](https://cdnweb.devolutions.net/docs/docs_en_server_ServerOp2078.png)
...
![Security settings](https://cdnweb.devolutions.net/docs/docs_en_server_ServerOp2079.png)
