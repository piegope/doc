---
eleventyComputed:
  title: "{{ en.WDAPP }} installation with {{ en.DHUBP }}"
...
![{{ en.DA }}](https://cdnweb.devolutions.net/docs/docs_en_hub_Hub2208.png)
...
![Back up entries on {{ en.DHUBP }}](https://cdnweb.devolutions.net/docs/docs_en_hub_Hub2209.png)
1. Click ***Next***.
...
1. Select {{ en.DHUBP }}.
1. Click ***OK***.
![Select {{ en.DHUBP }}.](https://cdnweb.devolutions.net/docs/docs_en_hub_Hub6103.png)
...
![Your {{ en.DHUBP }} account is now connected](https://cdnweb.devolutions.net/docs/docs_en_hub_Hub6101.png)