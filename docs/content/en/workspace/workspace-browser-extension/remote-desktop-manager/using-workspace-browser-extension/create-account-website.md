...
![Registration Page](https://cdnweb.devolutions.net/docs/docs_en_rdm_windows_RDMWin2084.png)
...
![Password Generator Tab](https://cdnweb.devolutions.net/docs/docs_en_rdm_windows_RDMWin2085.png)
...
![Password length](https://cdnweb.devolutions.net/docs/docs_en_rdm_windows_RDMWin2086.png)
{type="a"}
...
![General Settings](https://cdnweb.devolutions.net/docs/docs_en_rdm_windows_RDMWin2087.png)
...
![Advanced Settings](https://cdnweb.devolutions.net/docs/docs_en_rdm_windows_RDMWin2088.png)
...
![Generate Password](https://cdnweb.devolutions.net/docs/docs_en_rdm_windows_RDMWin2089.png)
1. Click on the ***Copy to Clipboard*** button to copy the password.
![Copy to Clipboard](https://cdnweb.devolutions.net/docs/docs_en_rdm_windows_RDMWin2090.png)
1. Paste your password in the website's corresponding field.
![Paste Password](https://cdnweb.devolutions.net/docs/docs_en_rdm_windows_RDMWin2091.png)
