...
![Settings Icon](https://cdnweb.devolutions.net/docs/docs_en_hub_Hub2093.png)
...
1. In the ***General*** tab, the ***Show icon in fields*** setting should be enabled by default. If not, check the box next to the option to enable it.
   ...
   ![Settings – Data sources – {{ en.DHUBP }}](https://cdnweb.devolutions.net/docs/docs_en_hub_Hub2082.png)
...
{type="a"}
    ...
    ![Entry Filter and Selection](https://cdnweb.devolutions.net/docs/docs_en_hub_Hub2184.png)
...
![Credentials Tranfer in Corresponding Fields](https://cdnweb.devolutions.net/docs/docs_en_hub_Hub2091.png)
