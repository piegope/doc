...
![Create your account](https://cdnweb.devolutions.net/docs/docs_en_cloud_Cloud4014.png)
...
4. Go to your email inbox and open the activation email that was sent to you.
   ...
   ![{{ en.DA }} activation](https://cdnweb.devolutions.net/docs/docs_en_cloud_Cloud4023.png)
...
![Username](https://cdnweb.devolutions.net/docs/docs_en_cloud_Cloud4001.png)
1. Click ***Forgot your password?***.
![Forgot your password?](https://cdnweb.devolutions.net/docs/docs_en_cloud_Cloud4024.png)
1. Enter your username again, then click ***Next***.
!Username](https://cdnweb.devolutions.net/docs/docs_en_cloud_Cloud4025.png)
1. Copy the code received in the email, then click ***Next***.
![Email code](https://cdnweb.devolutions.net/docs/docs_en_cloud_Cloud4026.png)
