...
{% snippet, "badgeInfo" %}
A license is now required to enable the PAM module. Please contact our [sales department](mailto:sales@devolutions.net) for more information about the license. The PAM features you have access to in {{ en.RDM }} will depend on the data source you are using.
{% endsnippet %}