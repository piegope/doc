...
1. Once PowerShell 7.2 or later is installed, open a PowerShell terminal and install the {{ en.PS }} module with the following command:
   ...
   ![Install-Module Command](https://cdnweb.devolutions.net/docs/en/hub/Hub2136.png)
...
1. Connect to your {{ en.DHUBB }} using the command below. If you do not see an error, it means you are connected to your {{ en.DHUBB }}.
   ...
   ![Connect-HubAccount Command](https://cdnweb.devolutions.net/docs/en/hub/Hub4062.png)
...
![Get-HubVault Command](https://cdnweb.devolutions.net/docs/en/hub/Hub4063.png)
...
![Get-HubEntry Command](https://cdnweb.devolutions.net/docs/en/hub/Hub4064.png)
...
![{{ en.DHUBB }} Command Return Variable](https://cdnweb.devolutions.net/docs/en/hub/Hub4065.png)
1. To edit this entry, you can change the object and update it with the `Set-HubEntry` command.
![Set-HubEntry Command](https://cdnweb.devolutions.net/docs/en/hub/Hub4066.png)
