...
![Administration – Authentication – Single Sign-On (SSO) – Okta Single Sign-On (SSO)](https://cdnweb.devolutions.net/docs/en/hub/HUBB2007_2024_1.png)

1. ***Name*** your SSO configuration. This name will only appear in your {{ en.DHUB }} SSO settings menu. The default name is "Okta".
![Configuration name](https://cdnweb.devolutions.net/docs/en/hub/Hub2334.png)
...
![Applications – Create App Integration](https://cdnweb.devolutions.net/docs/en/hub/Hub2238.png)
1. For the ***Sign-in method***, select ***OIDC - OpenID Connect***.
![Sign-in method – OIDC - OpenID Connect](https://cdnweb.devolutions.net/docs/en/hub/Hub2239.png)
1. For the ***Application type***, select ***Web Application***.
![Application type – Web Application](https://cdnweb.devolutions.net/docs/en/hub/Hub2240.png)
1. Click ***Next***. The ***New Web App Integration*** settings page will appear.
1. Under ***General Settings***, enter an ***App integration name***.
   ![App integration name](https://cdnweb.devolutions.net/docs/en/hub/Hub2249.png)
...
![Grant type](https://cdnweb.devolutions.net/docs/en/hub/Hub2250.png)
...
![Copy the Callback URL](https://cdnweb.devolutions.net/docs/en/hub/Hub2336.png)

**In Okta**

11. Back in Okta, paste the ***Callback URL*** in the ***Sign-in redirect URIs*** field.
![Sign-in redirect URIs](https://cdnweb.devolutions.net/docs/en/hub/Hub2251.png)
...
![Copy the Logout redirect URL](https://cdnweb.devolutions.net/docs/en/hub/Hub2335.png)

**In Okta**

13. Back in Okta, paste the ***Logout redirect URL*** in the ***Sign-out redirect URIs*** field.
![Sign-out redirect URIs](https://cdnweb.devolutions.net/docs/en/hub/Hub2252.png)
...
1. Under ***Assignments***, select the ***Controlled access*** option that best suits your needs. This choice is left to your discretion.
   ...
   ![Assignments](https://cdnweb.devolutions.net/docs/en/hub/Hub2253.png)
...
![Copy the Client ID](https://cdnweb.devolutions.net/docs/en/hub/Hub2254.png)

**In {{ en.DHUBB }}**

17. Back on the ***Configure Single Sign-On (SSO)*** page, paste the ***Client ID*** from the last step in the field of the same name.
![Client ID](https://cdnweb.devolutions.net/docs/en/hub/Hub2337.png)

**In Okta**

18. Back in Okta, copy the ***Client secret*** by clicking on the ***Copy to clipboard*** icon next to it.
![Copy the Client secret](https://cdnweb.devolutions.net/docs/en/hub/Hub2256.png)
...
![Client secret Key](https://cdnweb.devolutions.net/docs/en/hub/Hub2338.png)
1. In ***Discovery URL***, enter the URL you use to access Okta, without the "-admin" part.
   ...
   ![Discovery URL](https://cdnweb.devolutions.net/docs/en/hub/Hub2339.png)

**In Okta**

21. Click ***Edit*** in the ***General Settings*** section.
![Edit the General Settings](https://cdnweb.devolutions.net/docs/en/hub/Hub2260.png)
1. Set the ***Refresh token behavior*** to ***Rotate token after every use***.
![Rotate token after every use](https://cdnweb.devolutions.net/docs/en/hub/Hub2261.png)
1. Click ***Save***.
...
![Assignment](https://cdnweb.devolutions.net/docs/en/hub/Hub2262.png)
...
![Save the configuration](https://cdnweb.devolutions.net/docs/en/hub/Hub2340.png)
...
![Active SSO configuration](https://cdnweb.devolutions.net/docs/en/hub/HUBB2008_2024_1.png)
