...
![Invitation required](https://cdnweb.devolutions.net/docs/en/hub/Hub4141.png)
...
![Step 1 - From Organization](https://cdnweb.devolutions.net/docs/en/hub/Hub2176.png)
...
![Step 2 - By Emails](https://cdnweb.devolutions.net/docs/en/hub/Hub2177.png)

4. ***Step 3 - Options***: Select ***Options*** for users, then click ***Next***.
![Step 3 - Options](https://cdnweb.devolutions.net/docs/en/hub/Hub2178.png)
...
![Step 4 - User groups](https://cdnweb.devolutions.net/docs/en/hub/Hub2179.png)
