...
![Create your {{ en.DHUBP }}](https://cdnweb.devolutions.net/docs/en/hub/Hub4055.png)
{% snippet icon.badgeHelp %}
If you are a {{ en.RDM }} Free Edition user, you can connect your {{ en.DHUBP }} as a data source in ***File – Data sources – Add a new data source***. Learn more about [integrating {{ en.DHUBP }} in {{ en.RDM }}](/kb/hub-personal/how-to-articles/integrate-hub-personal-rdm/).
{% endsnippet %}

4. Download your ***Emergency Kit***.
![Emergency Kit](https://cdnweb.devolutions.net/docs/en/hub/Hub4092.png)
