...
![{{ en.DGW }}](https://cdnweb.devolutions.net/docs/en/hub/DGW0008.png)
1. In the same section, set the ***Connect*** option to ***Always connect***.
![Always Connect](https://cdnweb.devolutions.net/docs/en/hub/DGW0009.png)
1. In the ***Settings ({{ en.DGW }})*** tab select the gateway configured in [{{ en.DHUBB }} Configuration](/hub/dgw/hub-business-configuration/).
![Settings](https://cdnweb.devolutions.net/docs/en/hub/DGW0007.png)
...
![Reports – Gateway Sessions](https://cdnweb.devolutions.net/docs/en/hub/DGW0052.png)
