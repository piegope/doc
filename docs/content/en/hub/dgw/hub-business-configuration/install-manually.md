...
![Administration Tab](https://cdnweb.devolutions.net/docs/en/hub/DGW0020.png)
1. Click on {{ en.DGW }}, which is under the ***Management*** section.
![{{ en.DGW }} Button](https://cdnweb.devolutions.net/docs/en/hub/DGW0021.png)
1. Click on the ***Add*** ( ***+*** ) button in the top right.
![Add Button](https://cdnweb.devolutions.net/docs/en/hub/DGW0022.png)
1. Select ***Install Manually*** from the dropdown.
![Install Manually](https://cdnweb.devolutions.net/docs/en/hub/DGW0023.png)
1. Download the {{ en.DGW }} ***installer*** and execute it.
![Installer](https://cdnweb.devolutions.net/docs/en/hub/DGW0027.png)
...
![Gateway Public Key](https://cdnweb.devolutions.net/docs/en/hub/DGW0028.png)
   {% snippet icon.badgeInfo %}
   The installer should be run on the server hosting {{ en.DGW }}.
   {% endsnippet %}
1. Click ***Next***.
![Setup Wizard](https://cdnweb.devolutions.net/docs/en/hub/DGW0024.png)
1. Once the desired installation path is selected, click ***Next***.
![Destination Folder](https://cdnweb.devolutions.net/docs/en/hub/DGW0025.png)
1. Select ***Configure now***, then click ***Next***.
![Configure Now](https://cdnweb.devolutions.net/docs/en/hub/DGW0026.png)
1. Input your {{ en.DGW }} access URI. The default port is 443, but can be changed. Click ***Next***.
![Access URI](https://cdnweb.devolutions.net/docs/en/hub/DGW0029.png)
...
![Listeners](https://cdnweb.devolutions.net/docs/en/hub/DGW0030.png)
...
![Certificate](https://cdnweb.devolutions.net/docs/en/hub/DGW0031.png)
1. Click on the ellipsis button and select the ***Provisioner Public Key*** which was generated in Step 7.
![Public Key](https://cdnweb.devolutions.net/docs/en/hub/DGW0032.png)
1. Select the ***Automatically*** option for Service Startup and click ***Next***.
![Service Startup](https://cdnweb.devolutions.net/docs/en/hub/DGW0033.png)
...
![Gateway Setup Summary](https://cdnweb.devolutions.net/docs/en/hub/DGW0034.png)
1. Click ***Install***.
![Install Button](https://cdnweb.devolutions.net/docs/en/hub/DGW0035.png)
...
![Information Fields](https://cdnweb.devolutions.net/docs/en/hub/DGW0036.png)
![Information Fields](https://cdnweb.devolutions.net/docs/en/hub/DGW0041.png)
...
![Default](https://cdnweb.devolutions.net/docs/en/hub/DGW0037.png)
1. Make certain the gateway can be reached by clicking ***Test Connection***.
![Test Connection Button](https://cdnweb.devolutions.net/docs/en/hub/DGW0038.png)
1. Click the ***Add*** button to link your {{ en.DGW }} installation to your {{ en.DHUBB }}.
![Add Button](https://cdnweb.devolutions.net/docs/en/hub/DGW0039.png)
1. A rectangle will show the information for every {{ en.DGW }} Hub link(s).
![Successful Link](https://cdnweb.devolutions.net/docs/en/hub/DGW0040.png)
{% snippet icon.badgeInfo %}
