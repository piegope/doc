...
![First Login](https://cdnweb.devolutions.net/docs/en/hub/Dwl4050.png)
1. ***Log In*** to your account.
![Connecting {{ en.DHUBP }} to the {{ en.DA }}](https://cdnweb.devolutions.net/docs/en/hub/Dwl4054.png)
...
![Successful Login to the {{ en.DA }}](https://cdnweb.devolutions.net/docs/en/hub/Dwl4051.png)
1. Click on the {{ en.WBEX }} icon in the toolbar of your web browser to validate that the {{ en.WBEX }} is now connected to {{ en.DHUBP }}.
![Successful Pairing of {{ en.DHUBP }} to the {{ en.WBEX }}](https://cdnweb.devolutions.net/docs/en/hub/Dwl4052.png)
