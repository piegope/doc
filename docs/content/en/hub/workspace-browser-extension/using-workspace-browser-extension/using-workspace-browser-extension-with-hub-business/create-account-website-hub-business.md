...
![Registration Page](https://cdnweb.devolutions.net/docs/docs_en_hub_Hub2046.png)
...
![Password Generator Tab](https://cdnweb.devolutions.net/docs/docs_en_hub_Hub2047.png)
...
![Password length](https://cdnweb.devolutions.net/docs/docs_en_hub_Hub2048.png)
{type="a"}
...
![General Settings](https://cdnweb.devolutions.net/docs/docs_en_hub_Hub2049.png)
...
![Advanced Settings](https://cdnweb.devolutions.net/docs/docs_en_hub_Hub2050.png)
...
![Generate Password](https://cdnweb.devolutions.net/docs/docs_en_hub_Hub2051.png)
1. Click on the ***Copy to Clipboard*** button to copy the password.
![Copy to Clipboard](https://cdnweb.devolutions.net/docs/docs_en_hub_Hub2052.png)
