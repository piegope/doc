...
![Settings Icon](https://cdnweb.devolutions.net/docs/en/hub/Hub2080.png)
...
1. In the ***General*** tab, the ***Show icon in fields*** setting should be enabled by default. If not, check the box next to the option to enable it.
   ...
   ![General – Show icon in fields](https://cdnweb.devolutions.net/docs/en/hub/Hub2082.png)

1. Click ***Save***.
1. Click on ***{{ en.DHUBB }}*** in the ***Data sources*** section.
![Settings – Data sources – {{ en.DHUBB }}](https://cdnweb.devolutions.net/docs/en/hub/Hub2083.png)
...
![Actions – Automatically fill in credentials on load](https://cdnweb.devolutions.net/docs/en/hub/Hub2084.png)
   {% snippet icon.badgeInfo %}
...
![Entry Filter and Selection](https://cdnweb.devolutions.net/docs/en/hub/Hub2089.png)
...
![Entry Selection](https://cdnweb.devolutions.net/docs/en/hub/Hub2090.png)
...
![Credentials Transfer in Corresponding Fields](https://cdnweb.devolutions.net/docs/en/hub/Hub2091.png)
