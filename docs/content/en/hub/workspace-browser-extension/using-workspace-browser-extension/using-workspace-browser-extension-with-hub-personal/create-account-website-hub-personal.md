...
If you already have an account for the website, visit [Add an entry with the {{ en.WBEX }}](/hub/workspace-browser-extension/using-workspace-browser-extension/using-workspace-browser-extension-with-hub-personal/add-entry-hub-personal-workspace-browser-extension/).
{% endsnippet %}
...
![Registration Page](https://cdnweb.devolutions.net/docs/docs_en_hub_Hub2060.png)
1. Follow the website’s registration process until you get to the password field.
1. Click on the {{ en.WBEX }} icon in your browser toolbar, then select the ***Password Generator*** in the tab menu.
![Password Generator Tab](https://cdnweb.devolutions.net/docs/docs_en_hub_Hub2061.png)
...
![Password length](https://cdnweb.devolutions.net/docs/docs_en_hub_Hub2062.png)
{type="a"}
...
![General Settings](https://cdnweb.devolutions.net/docs/docs_en_hub_Hub2063.png)
...
![Advanced Settings](https://cdnweb.devolutions.net/docs/docs_en_hub_Hub2064.png)
...
![Generate Password](https://cdnweb.devolutions.net/docs/docs_en_hub_Hub2065.png)
1. Click on the ***Copy to Clipboard*** button to copy the password.
![Copy to Clipboard](https://cdnweb.devolutions.net/docs/docs_en_hub_Hub2066.png)
1. Paste your password in the website’s corresponding field.
![Paste Password](https://cdnweb.devolutions.net/docs/docs_en_hub_Hub2053.png)
...
![Add Website](https://cdnweb.devolutions.net/docs/docs_en_hub_Hub2183.png)
