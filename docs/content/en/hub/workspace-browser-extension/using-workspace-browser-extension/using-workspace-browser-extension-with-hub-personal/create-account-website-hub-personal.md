...
![Registration Page](https://cdnweb.devolutions.net/docs/en/hub/Hub2060.png)
...
![Password Generator Tab](https://cdnweb.devolutions.net/docs/en/hub/Hub2061.png)
...
![Password length](https://cdnweb.devolutions.net/docs/en/hub/Hub2062.png)
{type="a"}
...
![General Settings](https://cdnweb.devolutions.net/docs/en/hub/Hub2063.png)
...
![Advanced Settings](https://cdnweb.devolutions.net/docs/en/hub/Hub2064.png)
...
![Generate Password](https://cdnweb.devolutions.net/docs/en/hub/Hub2065.png)
1. Click on the ***Copy to Clipboard*** button to copy the password.
![Copy to Clipboard](https://cdnweb.devolutions.net/docs/en/hub/Hub2066.png)
1. Paste your password in the website’s corresponding field.
![Paste Password](https://cdnweb.devolutions.net/docs/en/hub/Hub2053.png)
...
![Add Website](https://cdnweb.devolutions.net/docs/en/hub/Hub2183.png)
