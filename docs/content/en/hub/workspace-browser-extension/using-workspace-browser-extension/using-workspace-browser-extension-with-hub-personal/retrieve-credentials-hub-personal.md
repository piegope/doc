...
You need website entries in {{ en.DHUBP }} to be able to retrieve their credentials. If that is not the case, start by [adding a website entry with the {{ en.WBEX }}](/hub/workspace-browser-extension/using-workspace-browser-extension/using-workspace-browser-extension-with-hub-personal/add-entry-hub-personal-workspace-browser-extension/).
{% endsnippet %}
...
After the [installation](/hub/workspace-browser-extension/installation/) of the {{ en.WBEX }} and its [pairing](/hub/workspace-browser-extension/first-login-workspace-browser-extension/hub-personal/) with {{ en.DHUBP }}, you can immediately use the extension to retrieve your credentials. However, you may want to modify some of the settings to customize your experience. We recommend that you follow the steps in the Settings section first: they will guide you through setting up the {{ en.WBEX }} by suggesting best practices for retrieving credentials. You can also skip the configuration and go straight to Retrieving credentials.

## Settings

1. Click on the {{ en.WBEX }} button in your browser, then click on the ***Settings*** icon.
![Settings Icon](https://cdnweb.devolutions.net/docs/en/hub/Hub2093.png)
1. Click on ***General*** in the ***Configuration*** section.
![Settings – Configuration – General](https://cdnweb.devolutions.net/docs/en/hub/Hub2081.png)
1. In the ***General*** tab, the ***Show icon in fields*** setting should be enabled by default. If not, check the box next to the option to enable it.
   ...
   ![Settings – Data sources – {{ en.DHUBP }}](https://cdnweb.devolutions.net/docs/en/hub/Hub2082.png)

4. Click ***Save***.
1. Click on ***{{ en.DHUBP }}*** in the ***Data sources*** section.
![General – Show icon in fields](https://cdnweb.devolutions.net/docs/en/hub/Hub2094.png)
...
![Actions – Automatically fill in credentials on load](https://cdnweb.devolutions.net/docs/en/hub/Hub2092.png)
   {% snippet icon.badgeInfo %}
...
![Automatically Filled Credentials Fields](https://cdnweb.devolutions.net/docs/en/hub/Hub2088.png)
{type="a"}
    ...
    ![Entry Filter and Selection](https://cdnweb.devolutions.net/docs/en/hub/Hub2184.png)
...
![Entry Selection](https://cdnweb.devolutions.net/docs/en/hub/Hub2096.png)
...
![Credentials Tranfer in Corresponding Fields](https://cdnweb.devolutions.net/docs/en/hub/Hub2091.png)
