...
![Go to extensions](https://cdnweb.devolutions.net/docs/docs_en_cloud_CLOUD2009_2024_1.png)
1. Click ***Install***, then ***Yes, install***.
![Install the {{ en.WBEX }}](https://cdnweb.devolutions.net/docs/docs_en_cloud_CLOUD2013_2024_1.png)
1. Click on the Opera ***Extensions*** button and ***Pin*** the {{ en.WBEX }} to finish the installation.
![Pin the {{ en.WBEX }}](https://cdnweb.devolutions.net/docs/docs_en_cloud_CLOUD2012_2024_1.png)
