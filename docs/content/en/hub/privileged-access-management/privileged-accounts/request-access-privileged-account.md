...
1. Select the privileged account entry you want to access, then click on ***Check Out***.
   ...
   ![Privileged account check-out](https://cdnweb.devolutions.net/docs/en/hub/Hub2319.png)
...
![Send request to](https://cdnweb.devolutions.net/docs/en/hub/Hub2304.png)
1. Select the ***Access duration*** in the drop-down menu.
![Access duration](https://cdnweb.devolutions.net/docs/en/hub/Hub2305.png)
1. Write a short ***Comment*** to the approver explaining why you want access to this entry.
![Comment](https://cdnweb.devolutions.net/docs/en/hub/Hub2310.png)
...
![Confirmation email](https://cdnweb.devolutions.net/docs/en/hub/Hub2306.png)
...
![Approved check-out request](https://cdnweb.devolutions.net/docs/en/hub/Hub2318.png)
...
![Check-out request details and check-in](https://cdnweb.devolutions.net/docs/en/hub/Hub2309.png)
