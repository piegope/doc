---
eleventyComputed:
  title: "{{ en.WMAPP }} setup with {{ en.DHUBP }}"
...
![{{ en.DHUBP }} setup](https://cdnweb.devolutions.net/docs/en/hub/Hub2215.png)
...
![{{ en.DA }}](https://cdnweb.devolutions.net/docs/en/hub/Hub2216.png)
...
![Back up entries on {{ en.DHUBP }}](https://cdnweb.devolutions.net/docs/en/hub/Hub2217.png)
1. Tap ***Next***.
