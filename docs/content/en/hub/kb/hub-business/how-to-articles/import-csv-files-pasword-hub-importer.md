...
{% snippet, "badgeInfo" %}
This topic assumes that your CSV files are ready to be imported. For tips and recommendations on how to prepare your CSV files for importation, visit [CSV files import strategies and format with {{ en.DHUBI }}](/hub/kb/hub-business/knowledge-base/csv-files-import-strategies-format-hub-importer/).
...
1. Once logged in, select the ***CSV*** format in the ***Import Type*** menu. Then, click on the ellipsis button next to the ***Source*** field to open the ***Import Csv Wizard***.
   ...
   ![CSV Import Type](https://cdnweb.devolutions.net/docs/docs_en_kb_KB2112.png)
...
![Header Format Instruction Selection](https://cdnweb.devolutions.net/docs/docs_en_kb_KB2114.png)
1. Click on the ellipsis button next to the ***Open CSV file*** field to select your files to import.
![Open CSV File](https://cdnweb.devolutions.net/docs/docs_en_kb_KB2115.png)
...
![Settings and Preview](https://cdnweb.devolutions.net/docs/docs_en_kb_KB2121.png)
...
![Edit, Add, or Delete Variables](https://cdnweb.devolutions.net/docs/docs_en_kb_KB2124.png)

1. When done, click ***Finish***.
1. In the ***Target {{ en.VLT }}*** drop-down list, select the {{ en.VLT }} in which to import your entries.
![Target {{ en.VLT }} selection](https://cdnweb.devolutions.net/docs/docs_en_kb_KB2116.png)
