...
![Help & Tools – Import](https://cdnweb.devolutions.net/docs/en/hub/HUBB2018_2024_1.png)
1. Select the format of the imported file (JSON or CSV) between the following options: 
   ...
   ![Import format](https://cdnweb.devolutions.net/docs/en/hub/HUBB2019_2024_1.png)
...
![Destination {{ en.VLT }} and folder](https://cdnweb.devolutions.net/docs/en/hub/HUBB2020_2024_1.png)
1. Click ***Import***.
1. A summary of all the entries to import will appear. Click ***Complete import***.
![Complete import](https://cdnweb.devolutions.net/docs/en/hub/HUBB2021_2024_1.png)  
...
![Help & Tools – Export](https://cdnweb.devolutions.net/docs/en/hub/HUBB2022_2024_1.png)
1. Select the ***PowerShell Script*** export type.
![PowerShell Script export type](https://cdnweb.devolutions.net/docs/en/hub/HUBB2025_2024_1.png)
...
![Automatic option](https://cdnweb.devolutions.net/docs/en/hub/HUBB2023_2024_1.png)
...
![Manual option](https://cdnweb.devolutions.net/docs/en/hub/HUBB2024_2024_1.png)
1. Choose to export in JSON or CSV.
...
![JSON export type](https://cdnweb.devolutions.net/docs/en/hub/HUBB2026_2024_1.png)
...
![Select the folder(s) to export](https://cdnweb.devolutions.net/docs/en/hub/HUBB2027_2024_1.png)
