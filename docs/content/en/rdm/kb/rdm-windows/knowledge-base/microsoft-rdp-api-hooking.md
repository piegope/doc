...
eleventyComputed:
  ...
  description: Enable API hooking in File – Settings – Types – Sessions – Remote Desktop (RDP) – API Hooking.
---
...
If you have disabled it, you can enable it again by going in {{ en.RDM }} ***File – Settings – Types – Sessions – Remote Desktop (RDP) – API Hooking*** and setting ***Enable API hooking*** to ***Enabled*** or ***Default***.
...
See all policies including this one in [Apply policies](/rdm/kb/rdm-windows/how-to-articles/group-policies/).
{% endsnippet %}
