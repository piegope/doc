...
* SQL Server to Azure SQL or Azure SQL to SQL Server: Follow the steps in this [SQL Server database migration best practice](/rdm/kb/rdm-windows/how-to-articles/sql-server-database-migration/) guide.
