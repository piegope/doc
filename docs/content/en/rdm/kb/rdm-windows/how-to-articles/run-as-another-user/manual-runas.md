...
---
{% snippet, "badgeInfo" %}
This article describes the manual method of using RunAs. Some types support built-in RunAs details are available. See [Run as another user](/rdm/kb/rdm-windows/how-to-articles/run-as-another-user/).
{% endsnippet %}
