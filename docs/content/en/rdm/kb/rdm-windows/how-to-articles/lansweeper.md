...
The IT Asset Management feature can be used to link an asset manager (e.g., [BlueTally](/rdm/kb/rdm-windows/how-to-articles/it-asset-management/), Lansweeper) through an entry's properties. An embedded tab will then display the main landing page for Lansweeper. You can also easily switch between your data in {{ en.RDM }} and Lansweeper.
