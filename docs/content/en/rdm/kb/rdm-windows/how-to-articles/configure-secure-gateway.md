...
{type="a"}
    1. ***VPN Group*** can be configured as explained in [Configure VPN for multiple sessions](/rdm/kb/rdm-windows/how-to-articles/configure-vpn-multiple-sessions/). We Strongly recommend configuring VPN Group if many RDP/Web Browser session uses the same Secure Gateway.
