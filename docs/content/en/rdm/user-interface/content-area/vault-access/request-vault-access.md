...
![Ellipsis in {{ en.VLT }} selector](https://webdevolutions.azureedge.net/docs/en/rdm/windows/RDMWin2153.png)
1. Go to the ***Request {{ en.VLT }} Access*** tab.  
![Request {{ en.VLT }} Access tab](https://webdevolutions.azureedge.net/docs/en/rdm/windows/RDMWin2154.png)
