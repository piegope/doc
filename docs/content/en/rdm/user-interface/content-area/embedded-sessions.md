...
![Display Mode Settings](https://cdnweb.devolutions.net/docs/docs_en_rdm_windows_clip11186.png)
...
![Split Window - Drag And Drop](https://cdnweb.devolutions.net/docs/docs_en_rdm_windows_clip11187.png)

Below is an example of a side-by-side split window.
![Split Window - Side-By-Side](https://cdnweb.devolutions.net/docs/docs_en_rdm_windows_clip11188.png)
