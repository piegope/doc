...
![Display Mode Settings](https://cdnweb.devolutions.net/docs/en/rdm/windows/clip11186.png)
...
![Split Window - Drag And Drop](https://cdnweb.devolutions.net/docs/en/rdm/windows/clip11187.png)

Below is an example of a side-by-side split window.
![Split Window - Side-By-Side](https://cdnweb.devolutions.net/docs/en/rdm/windows/clip11188.png)
Below is an example of a top-down split window.
![!!clip11189](https://cdnweb.devolutions.net/docs/en/rdm/windows/clip11189.png)
