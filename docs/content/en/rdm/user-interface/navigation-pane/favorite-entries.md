...
![Favorites Tab](https://cdnweb.devolutions.net/docs/en/rdm/windows/clip11213.png)
...
![View – Panels – Favorites](https://cdnweb.devolutions.net/docs/en/rdm/windows/clip3578.png)

### Flag an entry as favorite

Right-click an entry in the ***{{ en.NPANE }}***, then select ***Favorite***.
![Favorite an entry](https://cdnweb.devolutions.net/docs/en/rdm/windows/RDMWin2013.png)
...
![Add folders to organize favorites](https://cdnweb.devolutions.net/docs/en/rdm/windows/clip3580.png)
...
![Overlayed Favorite Icons](https://cdnweb.devolutions.net/docs/en/rdm/windows/RDMWin2083.png)
