...
![Windjammer tree view structure](https://cdnweb.devolutions.net/docs/docs_en_rdm_windows_RDMWin6043.png)
...
![Administrator Permission](https://cdnweb.devolutions.net/docs/docs_en_rdm_windows_RDMWin6077.png)

The ServiceDesk:

* ***Add***
* ***Edit***
![ServiceDesk Rights](https://cdnweb.devolutions.net/docs/docs_en_rdm_windows_RDMWin6137.png)

The HelpDesk:

* ***Add***
![HelpDesk Rights](https://cdnweb.devolutions.net/docs/docs_en_rdm_windows_RDMWin6136.png)

The MontrealConsultant has read-only access. He cannot see any password or entry detail.

![MontrealConsultant Rights](https://cdnweb.devolutions.net/docs/docs_en_rdm_windows_RDMWin6080.png)
...
![Downhill Pro - Permissions](https://cdnweb.devolutions.net/docs/docs_en_rdm_windows_RDMWin6072.png)
...
![Telemark - Permissions](https://cdnweb.devolutions.net/docs/docs_en_rdm_windows_RDMWin6075.png)
...
![Telemark/Credentials - Permissions](https://cdnweb.devolutions.net/docs/docs_en_rdm_windows_RDMWin6049.png)
...
![Telemark/Credentials/Admin - Permissions](https://cdnweb.devolutions.net/docs/docs_en_rdm_windows_RDMWin6050.png)
...
![Telemark/Boston - Permissions](https://cdnweb.devolutions.net/docs/docs_en_rdm_windows_RDMWin6073.png)
...
![Telemark/Montreal - Permissions](https://cdnweb.devolutions.net/docs/docs_en_rdm_windows_RDMWin6074.png)
...
![Windjammer - Permissions](https://cdnweb.devolutions.net/docs/docs_en_rdm_windows_RDMWin6053.png)
...
![Side by side tree views](https://cdnweb.devolutions.net/docs/docs_en_rdm_windows_RDMWin6054.png)
