...
1. Click ***Get***.
![{{ en.WBEX }} in Edge Add-ons](https://cdnweb.devolutions.net/docs/docs_en_dwl_Dwl4012.png)
1. Add the extension to Microsoft Edge by clicking on ***Add extension***.
![Add te {{ en.WBEX }} to Microsoft Edge](https://cdnweb.devolutions.net/docs/docs_en_dwl_Dwl4013.png)
