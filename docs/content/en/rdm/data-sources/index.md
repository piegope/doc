...
![Select a Data Source](https://cdnweb.devolutions.net/docs/en/rdm/windows/clip11369.png)

## Startup data source

You may assign a data source to open automatically when {{ en.RDM }} starts.
![Startup Data Source](https://cdnweb.devolutions.net/docs/en/rdm/windows/clip10940.png)
