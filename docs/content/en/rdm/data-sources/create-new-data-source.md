...
![Open Data Source menu](https://cdnweb.devolutions.net/docs/en/rdm/windows/clip11364.png)
1. Click the ***Add a New Data Source*** button.
![Add a New Data Source](https://cdnweb.devolutions.net/docs/en/rdm/windows/clip10816.png)
1. Select the type of data source to create.
![Select your Data Source type](https://cdnweb.devolutions.net/docs/en/rdm/windows/clip11365.png)
...
![SQL Server - Connection Tab](https://cdnweb.devolutions.net/docs/en/rdm/windows/clip11366.png)
1. Once created, select the new data source by selecting it from the data source drop-down list at the top of the ***{{ en.NPANE }}***.
![Select your Data Source](https://cdnweb.devolutions.net/docs/en/rdm/windows/clip11369.png)
