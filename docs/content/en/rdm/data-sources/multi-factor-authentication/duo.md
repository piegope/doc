...
![Duo – General Settings](https://cdnweb.devolutions.net/docs/docs_en_rdm_windows_clip10017.png)
1. All the information necessary to fill in the ***Duo Settings*** fields in {{ en.RDM }} will be generated by the Duo account.
![Duo Account – Partner Auth API Details](https://cdnweb.devolutions.net/docs/docs_en_rdm_windows_clip6002.png)
1. Copy and paste all the information in the corresponding fields in the ***Duo Settings*** window.
![Duo Settings](https://cdnweb.devolutions.net/docs/docs_en_rdm_windows_clip10018.png)
...
![Multi-Factor Configuration – Settings](https://cdnweb.devolutions.net/docs/docs_en_rdm_windows_RDMWin2148.png)
1. Select the device to use for the multi-factor authentication by clicking on ***Use this device***.
![Choose a Device](https://cdnweb.devolutions.net/docs/docs_en_rdm_windows_RDMWin2147.png)
...
![Configuration Save](https://cdnweb.devolutions.net/docs/docs_en_rdm_windows_clip10019.png)
