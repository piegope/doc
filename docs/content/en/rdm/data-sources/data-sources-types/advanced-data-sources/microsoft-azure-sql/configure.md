...
![Upgrade Tab](https://cdnweb.devolutions.net/docs/en/rdm/windows/clip10377.png)
...
![Connection to the Database with the {{ en.RDM }} Administrator Account](https://cdnweb.devolutions.net/docs/en/rdm/windows/clip11501.png)
