...
1. Click ***Add License***.
![Add License](https://cdnweb.devolutions.net/docs/en/rdm/windows/RDMWin2236.png)
...
1. Paste the license serial in the ***License*** field or import the license file using the ***Import*** button.
   ...
   ![License field and import](https://cdnweb.devolutions.net/docs/en/rdm/windows/RDMWin2238.png)
