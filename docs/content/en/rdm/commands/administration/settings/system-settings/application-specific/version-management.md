...
---
The ***Version management*** section allows the administrators to manage the data source availability in other versions of {{ en.RDM }}. It can be found under ***Administration – System settings***.

### Windows, macOS, and Linux

![Administration – System settings – Version management](https://cdnweb.devolutions.net/docs/RDMW2038_2024_1.png)
