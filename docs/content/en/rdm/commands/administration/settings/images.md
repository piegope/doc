...
![Entry Image Settings](https://cdnweb.devolutions.net/docs/en/rdm/windows/RDMWin6165.png)
   ...
   {% endsnippet %}
   ![Adding a subfolder](https://cdnweb.devolutions.net/docs/en/rdm/windows/RDMWin6151.png)

5. Click ***OK*** to close the window.
![Folder and subfolder](https://cdnweb.devolutions.net/docs/en/rdm/windows/RDMWin6152.png)
