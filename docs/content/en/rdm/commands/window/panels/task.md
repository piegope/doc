...
![Task button](https://cdnweb.devolutions.net/docs/en/rdm/windows/RDMWin6210.png)
...
![Task Window](https://cdnweb.devolutions.net/docs/en/rdm/windows/RDMWin2036.png)

### Creation of tasks

![!!RDMWin2038](https://cdnweb.devolutions.net/docs/en/rdm/windows/RDMWin2038.png)

For more information on how to create a task, see [***Task List***](/rdm/windows/commands/view/panels/task-list/#creating-a-task).

### Task Filter

![!!RDMWin2039](https://cdnweb.devolutions.net/docs/en/rdm/windows/RDMWin2039.png)
...
![Task Filter](https://cdnweb.devolutions.net/docs/en/rdm/windows/RDMWin2040.png)
...
![Tasks](https://cdnweb.devolutions.net/docs/en/rdm/windows/RDMWin2037.png)
