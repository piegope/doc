...
![Activity Logs Search Fields](https://cdnweb.devolutions.net/docs/RDMW6004_2024_2.png)
...
![Logs](https://cdnweb.devolutions.net/docs/RDMW6005_2024_2.png)
...
| Business unit       | Indicates whether the {{ en.VLT }} is part of a business unit.  |
