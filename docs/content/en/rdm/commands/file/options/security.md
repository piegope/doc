...
eleventyComputed:
  title: Security
  description: Use File – Settings – Security to configure security settings related to local application security, multi-factor authentication, locking, offline security, certificate security, and more.
---
...
![File – Settings – Security](https://cdnweb.devolutions.net/docs/docs_en_rdm_windows_RDMWin2152.png)
