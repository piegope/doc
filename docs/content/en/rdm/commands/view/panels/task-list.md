...
![Task List Button](https://cdnweb.devolutions.net/docs/docs_en_rdm_windows_RDMWin2058.png)
...
![Task List](https://cdnweb.devolutions.net/docs/docs_en_rdm_windows_clip11269.png)

### Creating a task

1. Click on ***Add*** to open the ***Task Management*** window.
![Add Button](https://cdnweb.devolutions.net/docs/docs_en_rdm_windows_clip10247.png)
1. Enter your task information, like the name of the task, the priority, the due date, the description, etc.
![Task Management](https://cdnweb.devolutions.net/docs/docs_en_rdm_windows_clip10248.png)
