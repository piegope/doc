...
1. In {{ en.RDM }}, go to ***File – Settings – Paths***.
...
![File – Settings – Paths – Default templates](https://cdnweb.devolutions.net/docs/docs_en_rdm_windows_RDMWin2163.png)
...
![Map network drive](https://cdnweb.devolutions.net/docs/docs_en_rdm_windows_RDMWin2164.png)
