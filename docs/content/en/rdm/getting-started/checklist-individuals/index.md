...
| Step 3 - Set up your Devolutions {{ en.OBACK }} | Devolutions [{{ en.OBACK }}](/cloud/overview/what-is-cloud/) allows you to securely back up your information for selected data sources. The backup is automatically executed 30 seconds after any modifications made to the data source content. It is a best practice to always back up your data source. <br> {% youtube 'KegabQ0JmRw' %} |
| Step 4 - Create your default settings | In ***File – Settings***, you can create, modify, or reset [default settings](/rdm/windows/commands/file/templates/default-settings/) for your templates. Each entry type is supported and can have a default template defined to fit your requirements. <br> {% youtube '4sib5cliffA' %} |
