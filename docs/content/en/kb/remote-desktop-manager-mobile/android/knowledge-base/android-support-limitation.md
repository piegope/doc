...
eleventyComputed:
  ...
  description: Devolutions will ensure compatibility of {{ en.RDM }} with the current version of the Android operating system (OS) and up to four major versions that directly precede it.
---
Devolutions will ensure compatibility of {{ en.RDM }} with the current version of the Android operating system (OS) and up to four major versions that directly precede it (e.g., from Android 14 to Android 10).
