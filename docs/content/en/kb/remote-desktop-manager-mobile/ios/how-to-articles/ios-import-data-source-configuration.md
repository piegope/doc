...
![!!KB4173](https://webdevolutions.azureedge.net/docs/en/kb/KB4173.png)
1. Launch iTunes and connect the iOS device to the computer. In iTunes, select the iOS device.  
![!!KB4174](https://webdevolutions.azureedge.net/docs/en/kb/KB4174.png)
1. Click ***Apps*** In the ***File Sharing*** area, select ***RDM*** and click ***Add*** file.  
![!!KB4175](https://webdevolutions.azureedge.net/docs/en/kb/KB4175.png)
...
![!!KB4176](https://webdevolutions.azureedge.net/docs/en/kb/KB4176.png)
1. Tap on the Ellipsis button and select ***Import***.  
![!!KB4177](https://webdevolutions.azureedge.net/docs/en/kb/KB4177.png)
1. Select therdd file and tap ***Done*** The file is now available to {{ en.RDMIOS }}.  
![!!KB4178](https://webdevolutions.azureedge.net/docs/en/kb/KB4178.png)
1. Back in the ***More*** section, navigate to the ***Data sources*** list and tap ***Import***.  
![!!KB4179](https://webdevolutions.azureedge.net/docs/en/kb/KB4179.png)
1. Select therdd file.  
![!!KB4180](https://webdevolutions.azureedge.net/docs/en/kb/KB4180.png)  
