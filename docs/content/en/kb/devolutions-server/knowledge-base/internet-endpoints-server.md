...
| {{ en.DVLS }} (instance and scheduler) and {{ en.DGW }} installation | https<area>://devolutions.net<br>https<area>://redirection.devolutions.com | [Create a {{ en.DVLS }} instance](/server/getting-started/installation/create-server-instance/)<br>[{{ en.DGW }} configuration with {{ en.DVLS }}](/dgw/server/server-configuration/) |
