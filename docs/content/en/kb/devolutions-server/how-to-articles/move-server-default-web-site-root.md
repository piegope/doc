...
![Uninstall the Scheduler](https://cdnweb.devolutions.net/docs/en/kb/KB6008_2024_1.png)  
...
![Stop the DefaultAppPool and the Devolutions Password application pool](https://cdnweb.devolutions.net/docs/en/kb/KB6004_2024_1.png)  
1. Under ***Sites***, select ***Default Web Site*** and stop it using the ***Stop button*** in the Actions pane.
![Select Default Web Site and stop it using the Stop button](https://cdnweb.devolutions.net/docs/en/kb/KB6009_2024_1.png)  
1. Remove the {{ en.DVLS }} web application under ***Default Web Site***.  
![Remove the {{ en.DVLS }} web application under Default Web Site](https://cdnweb.devolutions.net/docs/en/kb/KB6006_2024_1.png)  
...
![Select all files and folders and move them ](https://cdnweb.devolutions.net/docs/en/kb/KB4148.png)
1. Navigate to the ***Default Web Site folder***.
1. Delete the ***iis-85.png*** and ***iisstart.htm*** files.
![Delete the iis-85.png and iisstart.htm files](https://cdnweb.devolutions.net/docs/en/kb/KB4149.png)
1. Delete the ***{{ en.DVLS }} web application folder***.
![Delete the {{ en.DVLS }} web application folder](https://cdnweb.devolutions.net/docs/en/kb/KB4150.png)
1. Go back in ***IIS Manager*** and refresh the ***Default Web Site node***. The ***{{ en.DVLS }} web application folder*** should disappear.
![Refresh the Default Web Site node](https://cdnweb.devolutions.net/docs/en/kb/KB6011_2024_1.png)
...
![Remove the %SystemDrive% environment variable](https://cdnweb.devolutions.net/docs/en/kb/KB4152.png)
1. Before starting the ***Default Web Site***, it is possible to rename it. But it is not mandatory.  
![Before starting the Default Web Site, it is possible to rename it](https://cdnweb.devolutions.net/docs/en/kb/KB6012_2024_1.png)
...
![{{ en.DVLS }} login page](https://cdnweb.devolutions.net/docs/en/kb/KB6007_2024_1.png)  
...
![Install the Scheduler](https://cdnweb.devolutions.net/docs/en/kb/KB6010_2024_1.png)
