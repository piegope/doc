...
![!!KB4144](https://cdnweb.devolutions.net/docs/en/kb/KB4144.png)
...
![!!KB4145](https://cdnweb.devolutions.net/docs/en/kb/KB4145.png)
1. Under Sites, select Default Web Site and stop it using the Stop button in the Actions pane.
![!!KB4146](https://cdnweb.devolutions.net/docs/en/kb/KB4146.png)
1. Remove the {{ en.DVLS }} web application under Default Web Site.
![!!KB4147](https://cdnweb.devolutions.net/docs/en/kb/KB4147.png)
...
![!!KB4152](https://cdnweb.devolutions.net/docs/en/kb/KB4152.png)
1. Before starting the Default Web Site, it is possible to rename it. But it is not mandatory.
![!!KB4153](https://cdnweb.devolutions.net/docs/en/kb/KB4153.png)
...
![!!KB4154](https://cdnweb.devolutions.net/docs/en/kb/KB4154.png)
...
![!!KB8035](https://cdnweb.devolutions.net/docs/en/kb/KB8035.png)
