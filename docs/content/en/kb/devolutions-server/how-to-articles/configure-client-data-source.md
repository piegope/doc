...
![!!KB4365](https://cdnweb.devolutions.net/docs/en/kb/KB4365.png)

1. Add a ***New Data Source***.
![!!KB4366](https://cdnweb.devolutions.net/docs/en/kb/KB4366.png)

1. Select the ***{{ en.DVLS }}*** data source.
![!!KB4367](https://cdnweb.devolutions.net/docs/en/kb/KB4367.png)

1. Specify the settings.
![!!KB4368](https://cdnweb.devolutions.net/docs/en/kb/KB4368.png)
