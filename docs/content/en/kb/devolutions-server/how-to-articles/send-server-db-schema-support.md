...
1. Select the {{ en.DVLS }} instance in the {{ en.DVLSCONSOLE }} and click on the Edit button.  
   ![!!KB8098](https://webdevolutions.azureedge.net/docs/en/kb/KB8098.png)
1. Select the Database tab.
1. Click on the Save Schema button.  
   ![!!KB8095](https://webdevolutions.azureedge.net/docs/en/kb/KB8095.png)
1. Select the destination folder and set the file name.
1. Click on Save button.  
   ![!!KB8096](https://webdevolutions.azureedge.net/docs/en/kb/KB8096.png)  
   ![!!KB8097](https://webdevolutions.azureedge.net/docs/en/kb/KB8097.png)
