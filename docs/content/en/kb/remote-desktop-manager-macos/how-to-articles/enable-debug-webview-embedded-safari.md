...
![Safari – Preferences](https://webdevolutions.azureedge.net/docs/en/kb/KB6065.png) 
1. Go to ***Advanced***.
1. Check ***Show Develop menu in menu bar***.
![Advanced – Show Develop menu in menu bar](https://webdevolutions.azureedge.net/docs/en/kb/KB6066.png)  
...
![Develop – Name of your local machine](https://webdevolutions.azureedge.net/docs/en/kb/KB6071.png)  
The website is now listed under the local machine.
![Website under the local machine](https://webdevolutions.azureedge.net/docs/en/kb/KB6067.png)  
1. Click the website name to open the ***Safari Developer tools***.
![Safari Developer tools](https://webdevolutions.azureedge.net/docs/en/kb/KB6069.png)  
