...
![Import/Export](https://cdnweb.devolutions.net/docs/en/kb/KB2083.png)
...
![Import Source](https://cdnweb.devolutions.net/docs/en/kb/KB2084.png)
1. Upload your .csv or .json file.
![File Upload](https://cdnweb.devolutions.net/docs/en/kb/KB2085.png)
1. Select a ***Destination folder***.
![Destination Folder](https://cdnweb.devolutions.net/docs/en/kb/KB2086.png)
1. Click ***Next***.
1. Select which entry to import in your {{ en.DHUBP }}.
![Entry Selection](https://cdnweb.devolutions.net/docs/en/kb/KB2087.png)
...
![!!KB2088](https://cdnweb.devolutions.net/docs/en/kb/KB2088.png)
{% snippet icon.shieldCaution %}
...
![Entry Selection](https://cdnweb.devolutions.net/docs/en/kb/KB2089.png)
