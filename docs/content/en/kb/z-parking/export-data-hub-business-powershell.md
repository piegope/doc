...
![Export with PowerShell](https://cdnweb.devolutions.net/docs/en/kb/KB2079.png)
...
![Automatic Export](https://cdnweb.devolutions.net/docs/en/kb/KB2080.png)
...
![Manual Export](https://cdnweb.devolutions.net/docs/en/kb/KB2081.png)
1. Choose to export in ***Json*** or ***Csv*** format.
