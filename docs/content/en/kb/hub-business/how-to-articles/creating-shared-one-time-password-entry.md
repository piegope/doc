...
![Key in the Authenticator app section](https://webdevolutions.blob.core.windows.net/docs/en/kb/KB6204.png)
1. Go back to the OTP entry and add the key to the corresponding field.
1. Click ***Add***. Your entry is now created.  
![!!KB2050](https://webdevolutions.blob.core.windows.net/docs/en/kb/KB6203.png)
1. Select the OTP entry and click on ***View*** to show your OTP.  
![!!KB2051](https://webdevolutions.blob.core.windows.net/docs/en/kb/KB6202.png)
...
![!!KB2054](https://webdevolutions.blob.core.windows.net/docs/en/kb/KB6207.png)  
