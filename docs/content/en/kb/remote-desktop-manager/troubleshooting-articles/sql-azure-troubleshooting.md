...
![!!KB2007](https://cdnweb.devolutions.net/docs/en/kb/KB2007.png)
### Solution
To resolve this issue, please have a look at [Azure SQL](/rdm/windows/data-sources/data-sources-types/advanced-data-sources/microsoft-azure-sql/).
...
![!!KB2008](https://cdnweb.devolutions.net/docs/en/kb/KB2008.png)
### Solution
...
For more information, please have a look at [Configure Azure SQL AD Authentication](/rdm/windows/data-sources/data-sources-types/advanced-data-sources/microsoft-azure-sql/enable-azure-active-directory-authentication/configure-admin/).
