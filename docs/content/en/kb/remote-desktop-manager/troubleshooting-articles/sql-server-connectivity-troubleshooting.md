...
![SQL Server Configuration Manager](https://cdnweb.devolutions.net/docs/docs_en_kb_KB4060.png)
1. Expand the ***SQL Server Network Configuration***.
1. Select an instance.
![Select an instance](https://cdnweb.devolutions.net/docs/docs_en_kb_KB4245.png)
1. Right-click the desired protocol, then select ***Enable***.
![Enable the protocol](https://cdnweb.devolutions.net/docs/docs_en_kb_KB4230.png)
...
![Windows Firewall with Advanced Security](https://cdnweb.devolutions.net/docs/docs_en_kb_KB4277.png)
1. Select ***Inbound Rules*** in the left pane.
1. Right-click ***Inbound Rules*** and select ***New Rule***.
![New inbound rule](https://cdnweb.devolutions.net/docs/docs_en_kb_KB4278.png)
1. In the ***Rule Type*** page, select ***Port***, then click ***Next***.
![Port rule type](https://cdnweb.devolutions.net/docs/docs_en_kb_KB4279.png)
...
1. Select ***Specific local ports***, then type the port number of the instance of the Database Engine, then click ***Next***.
   ...
   ![TCP and specified local ports](https://cdnweb.devolutions.net/docs/docs_en_kb_KB4280.png)

1. In the ***Action*** page, select ***Allow the connection***, then click ***Next***.
![Allow the connection](https://cdnweb.devolutions.net/docs/docs_en_kb_KB4281.png)
1. In the ***Profile*** page, select the profiles that describe the computer connection environment, then click ***Next***.
![Profiles](https://cdnweb.devolutions.net/docs/docs_en_kb_KB4282.png)
1. In the ***Name*** page, enter a ***Name*** and ***Description*** for the rule, then click ***Finish***.
![Name and description](https://cdnweb.devolutions.net/docs/docs_en_kb_KB4283.png)
...
![Create a text document](https://cdnweb.devolutions.net/docs/docs_en_kb_KB4246.png)
1. Rename this file and change its file extension to ***.udl***.
   ...
   ![Rename the text document](https://cdnweb.devolutions.net/docs/docs_en_kb_KB4247.png)
...
![Login failed. The login is from an untrusted domain and cannot be used with windows authentication.](https://cdnweb.devolutions.net/docs/docs_en_kb_KB2009.png)
