...
4. In the session you want to use the ***Secret Server*** credentials with (RDP, etc.), you select the ***Credentials*** you created with ***Linked ({{ en.VLT }})***, and then you can click the ***Select from List*** to specify the account you wish to use.
