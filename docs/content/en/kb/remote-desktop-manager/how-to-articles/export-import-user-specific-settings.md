...
![Data Source and {{ en.VLT }} Selection](https://cdnweb.devolutions.net/docs/en/kb/KB6092.png)
1. Go to ***File – My Account Settings***.
1. Click ***User Specific Settings List*** under ***Settings***.
![File - My Account Settings - Settings – User Specific Settings List](https://cdnweb.devolutions.net/docs/en/kb/KB6093.png)
1. Click ***Export***.
![User Specific Settings List Export](https://cdnweb.devolutions.net/docs/en/kb/KB6094.png)
1. Save the .rds file on your computer.
1. Encrypt the file with a ***Password*** and click ***OK***.
![Specific Settings Encryption](https://cdnweb.devolutions.net/docs/en/kb/KB6095.png)
...
1. Go to ***File – My Account Settings***.
1. Click ***User Specific Settings List*** under ***Settings***.
![File - My Account Settings - Settings – User Specific List](https://cdnweb.devolutions.net/docs/en/kb/KB6093.png)
1. Click ***Import***.
![User Specific Settings List Import](https://cdnweb.devolutions.net/docs/en/kb/KB6096.png)
