...
![Convert Website (legacy) to Website](https://cdnweb.devolutions.net/docs/docs_en_kb_KB2077.png)
{% snippet icon.badgeInfo %}
...
![Batch Action Result Window](https://cdnweb.devolutions.net/docs/docs_en_kb_KB2078.png)
