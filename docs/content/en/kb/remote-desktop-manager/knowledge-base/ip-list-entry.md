...
1. Click ***OK***.
![It Asset Management – IP Address List](https://cdnweb.devolutions.net/docs/en/kb/KB6109.png)
1. In the ***IP Address List*** window, enter a ***Name*** and select a ***Folder***.
1. Click ***Add (+)***.
![IP Address List window – Add (+)](https://cdnweb.devolutions.net/docs/en/kb/KB6110.png)
1. Enter the ***Name***, ***IP / Host*** and ***Description*** of the IP address.
1. Click ***OK*** to close the window.
![Name, IP / Host and Description](https://cdnweb.devolutions.net/docs/en/kb/KB6111.png)
Enter the number of IP addresses to list. You can also edit or delete an IP address.
1. Click ***OK*** to save the entry.
![Enter your IP addresses](https://cdnweb.devolutions.net/docs/en/kb/KB6112.png)
