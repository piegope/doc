...
![New Entry – Macro/Script/Tool – Report](https://webdevolutions.azureedge.net/docs/en/kb/KB6081.png)
1. Click ***OK***.
...
![New Entry – Macro/Script/Tool – Report – General tab](https://webdevolutions.azureedge.net/docs/en/kb/KB6084.png)
1. Go to the ***Script tab*** and write your script. A sample is available at the bottom of the window.  
   ...
   ![Script tab](https://webdevolutions.azureedge.net/docs/en/kb/KB6082.png)
...
![Refresh, Save as and Print options](https://webdevolutions.azureedge.net/docs/en/kb/KB6083.png)
