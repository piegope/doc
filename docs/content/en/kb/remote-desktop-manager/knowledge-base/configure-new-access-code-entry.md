...
![New Entry – Credential Management – General – Access code](https://cdnweb.devolutions.net/docs/docs_en_kb_KB6024.png)
2. Name the entry and select its folder.
1. Choose a password and click ***OK*** to close the window.
![General tab](https://cdnweb.devolutions.net/docs/docs_en_kb_KB6022.png)

***View Password*** and ***Copy Password*** are now available in the ***Dashboard*** under ***Actions***.

![Dashboard – Actions](https://cdnweb.devolutions.net/docs/docs_en_kb_KB6025.png)
