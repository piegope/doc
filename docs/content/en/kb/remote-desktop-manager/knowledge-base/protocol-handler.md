...
![Create Web URL](https://cdnweb.devolutions.net/docs/docs_en_kb_KB4466.png)
1. The Url is stored in the clipboard.
![URL has been copied to the clipboard](https://cdnweb.devolutions.net/docs/docs_en_kb_KB4467.png)
