...
![{{ en.DA }} – Forgot Password](https://webdevolutions.azureedge.net/docs/en/kb/KB6197.png)  
...
![Click on the lock to access your {{ en.DHUB }}](https://webdevolutions.azureedge.net/docs/en/kb/KB6200.png)
...
![{{ en.DHUB }} – Administration – Emergency Kit – Reset Emergency Kit](https://webdevolutions.azureedge.net/docs/en/hub/Hub6085.png)