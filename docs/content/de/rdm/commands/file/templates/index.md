...
![Datei – Vorlagen](https://cdnweb.devolutions.net/docs/de/rdm/windows/clip10235.png)

## Verfügbarkeit

Bei der Erstellung einer Vorlage kann deren Verfügbarkeit in den ***Vorlageneinstellungen*** festgelegt werden.
![!!clip3585](https://cdnweb.devolutions.net/docs/de/rdm/windows/clip3585.png)
...
![!!clip3584](https://cdnweb.devolutions.net/docs/de/rdm/windows/clip3584.png)

Die Vorlage kann auch direkt beim Erstellen im Abschnitt ***Vorlage*** im Fenster ***Neuen Eintrag hinzufügen*** ausgewählt werden.
![!!clip10266](https://cdnweb.devolutions.net/docs/de/rdm/windows/clip10266.png)
...
![!!clip10164](https://cdnweb.devolutions.net/docs/de/rdm/windows/clip10164.png)
