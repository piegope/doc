...
Zwei Möglichkeiten stehen zur Verfügung: Sie können dafür den [Data Migration Assistant](#losung-1) (DMA) von Microsoft oder das [Microsoft SQL Server Management Studio](#losung-2) (SSMS) verwenden.

## Konfiguration
Wir empfehlen, folgende Bereinigungen vor der Migration durchzuführen.

* ***Administration – [Gelöschte Einträge bereinigen](/de/rdm/windows/commands/administration/clean-up/deleted-history/)***
* ***Administration – [Versionsverlauf bereinigen](/de/rdm/windows/commands/administration/clean-up/entries-history/)***
* ***Administration – [Aktivitätsprotokolle bereinigen](/de/rdm/windows/commands/administration/clean-up/logs/)***
...
![!!KB4731](https://cdnweb.devolutions.net/docs/de/kb/KB4731.png)
...
![!!KB4734](https://cdnweb.devolutions.net/docs/de/kb/KB4734.png)
...
![!!KB4735](https://cdnweb.devolutions.net/docs/de/kb/KB4735.png)
1. Warten Sie, bis die Migration abgeschlossen ist. Danach können Sie den ***Data Migration Assistant*** schließen.
![!!KB4736](https://cdnweb.devolutions.net/docs/de/kb/KB4736.png)
...
### Lösung 2 [BACPAC](https://learn.microsoft.com/de-de/sql/relational-databases/data-tier-applications/data-tier-applications?view=sql-server-ver15#bacpac)
