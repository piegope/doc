...
![!!KB2034](https://cdnweb.devolutions.net/docs/docs_en_kb_KB2034.png)
1. Tap on the Entry menu of the Data Source you wish to allow the Offline mode on and select ***Edit***.
![!!KB2035](https://cdnweb.devolutions.net/docs/docs_en_kb_KB2035.png)
1. In the Advanced tab enable the option ***Allow offline mode***.
![!!KB2036](https://cdnweb.devolutions.net/docs/docs_en_kb_KB2036.png)
1. In the Data Source menu select ***Settings***.
![!!KB2037](https://cdnweb.devolutions.net/docs/docs_en_kb_KB2037.png)
1. Tap on the option ***Data source is online*** to activate the Offline mode of your current data source.
![!!KB2038](https://cdnweb.devolutions.net/docs/docs_en_kb_KB2038.png)
...
![!!KB2039](https://cdnweb.devolutions.net/docs/docs_en_kb_KB2039.png)
