...
![The encryption file is missing, please contact your administrator error](https://cdnweb.devolutions.net/docs/DVLS4017_2024_1.png)
...
To navigate to the web application folder, you can use the ***Explore*** button from the {{ en.DVLSCONSOLE }}.
![Explore button](https://cdnweb.devolutions.net/docs/DVLSCONSOLE4006_2024_1.png)
![Windows File Explorer](https://cdnweb.devolutions.net/docs/DVLSCONSOLE4007_2024_1.png)
