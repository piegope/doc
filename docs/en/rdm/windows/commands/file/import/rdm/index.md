...
title: Import (.rdm)
---
{{ en.RDM }} allows you to import entries from previously exported Remote Desktop Manager files ( {{ en.RDM }} 's native export format) stored on your computer. 

{% snippet icon.badgeInfo %} 
For an overview of the Remote Desktop Manager file format and the impact of decisions made in this entry, see [RDM Import Strategies and File Format](/rdm/windows/commands/file/import/rdm/strategies-file-format/) . 
{% endsnippet %}
...
1. Select the Remote Desktop Manager file to import from your computer, then click ***Open*** . 
