---
eleventyComputed:
  title: Configure {{ en.RDM }} Active Directory Interactive (with MFA)
---
...
Use the servers defined Azure Active Directory Admin to create your first {{ en.RDM }} admin users. Once you've created, you can use this new account to create other users. 
