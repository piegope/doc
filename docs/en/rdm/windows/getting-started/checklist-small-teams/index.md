...
eleventyComputed:
  ...
  order: 30
  description: Here is a checklist designed to help IT administrators install and configure {{ en.RDM }} for the first time when working in a small team environment using SQL Server.
---
Here is a checklist designed to help IT administrators install and configure {{ en.RDM }} for the first time when working in a small team environment using SQL Server.  
