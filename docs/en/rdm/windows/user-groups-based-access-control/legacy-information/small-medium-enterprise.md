...
* ***Add*** 
* ***Edit*** 
![ServiceDesk Rights](https://webdevolutions.blob.core.windows.net/docs/en/rdm/windows/RDMWin6078.png) 

The HelpDesk:  

* ***Add***  
![HelpDesk Rights](https://webdevolutions.blob.core.windows.net/docs/en/rdm/windows/RDMWin60121.png) 
