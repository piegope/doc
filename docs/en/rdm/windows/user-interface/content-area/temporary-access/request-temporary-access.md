...
To learn how to approve or deny a request, visit [Grant temporary access to an entry in {{ en.RDM }}](/rdm/windows/user-interface/content-area/temporary-access/grant-temporary-access/). 
{% endsnippet %}
...
Once the approver has granted you access, you can go straight to your entry in {{ en.RDM }}. You now temporarily have access to the entry.  
