...
If your users each have their own individual data source ( {{ en.HUB }} Personal, SQLite), you need to provide them the license serial so they can manually register in ***Administration – Management – Licenses*** . 
{% endsnippet %}
