...
1. Install the desired version of {{ en.RDM }} , using the [Portable (USB)](Installation_PortableUSB) deployment model may be desirable if you are doing this on your personal workstation. 
