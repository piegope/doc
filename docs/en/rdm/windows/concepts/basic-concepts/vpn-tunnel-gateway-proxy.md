...
---
Create a secure connection between a local and a remote computer by connecting a VPN, VPN group, tunnel, gateway, or proxy entry to one or multiple session entries. {{ en.RDM }} natively supports various VPN connection types. If the specific type you want is not currently supported, you can explore our add-ons and manage them using the ***Add-On Manager***.
