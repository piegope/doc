...
This topic assumes that you have previously [installed the {{ en.WBEX }}](/rdm/windows/dwl/installation/) in your browser and that it is [connected to {{ en.RDM }}](/rdm/windows/dwl/first-login-devolutions-web-login/). 
{% endsnippet %}
