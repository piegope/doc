...
The Host Name configured in your API user in Password Manager Pro is not the same that you have configured in {{ en.RDM }} in ***File – My Account Settings – Password Manager Pro*** Please consult [Configure Password Manager Pro in {{ en.RDM }}](/rdm/mac/kb/rdm-windows/how-to-articles/rdm-mac-configure-password-manager-pro/) for more information on the configuration.
