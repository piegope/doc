...
* Compare the data source configuration with one that works from another user in ***File – Data Sources***.
    * If it still fails, [Export and Import the data source configuration (.rdd)](/rdm/mac/kb/rdm-windows/how-to-articles/import-export-data-sources-configuration/) from the working user.
