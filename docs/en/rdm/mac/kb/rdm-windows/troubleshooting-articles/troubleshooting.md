...
### Solution
This error is due to a corrupted Microsoft's .NET Framework installation. Please consult [Corrupted System File](/rdm/mac/kb/rdm-windows/troubleshooting-articles/net-corrupted-system-file/) for more information on how to resolve this issue.
