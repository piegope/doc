...
If you have a second set of domain credentials, you could use this trick to test locally. [Running {{ en.RDM }} as Another User](/rdm/mac/kb/rdm-windows/how-to-articles/running-rdm-as-another-user/)
