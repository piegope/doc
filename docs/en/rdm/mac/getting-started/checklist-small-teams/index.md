...
Step 8 - Assign permissions
		...
		<td>
[Permissions](/rdm/mac/commands/administration/user-management/permissions/) can be granted to users and user groups. They are set on the {{ en.VLT }}, folder, and entry levels.  
