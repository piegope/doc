---
title: Workspaces
description: Devolutions Workspace is both a mobile and desktop application that brings together Authenticator, Devolutions Hub Business, Devolutions Hub Personal, and Devolutions Server into a single, centralized, cloud-based location.
---
...
![](https://webdevolutions.blob.core.windows.net/docs/en/rdm/windows/RDMMac6041.png) 