...
![{{ en.VLT_MAJ }}s](https://webdevolutions.azureedge.net/docs/en/rdm/mac/RDMMac0020.png) 
...
![{{ en.NPANE }} {{ en.VLT }} tabs](https://webdevolutions.azureedge.net/docs/en/rdm/mac/RDMMac0021.png) 
