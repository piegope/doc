...
![Properties – Security – Permissions – Permissions tab](https://cdnweb.devolutions.net/docs/en/rdm/mac/RDMMac2101.png)
...
![Custom Default Permissions](https://cdnweb.devolutions.net/docs/en/rdm/mac/RDMMac2102.png)
1. Click on ***Grant Access***.
![Grant Access](https://cdnweb.devolutions.net/docs/en/rdm/mac/RDMMac2103.png)

The ***Batch Grant Access*** window is now open.
![Batch Grant Access](https://cdnweb.devolutions.net/docs/en/rdm/mac/RDMMac2104.png)
...
![Permission settings](https://cdnweb.devolutions.net/docs/en/rdm/mac/RDMMac2105.png)
...
![User selection](https://cdnweb.devolutions.net/docs/en/rdm/mac/RDMMac2106.png)
