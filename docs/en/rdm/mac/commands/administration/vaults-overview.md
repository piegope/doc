...
1. Choose a [{{ en.VLT }} content type](/rdm/mac/user-interface/customization/vault-types) (default, business, secrets, or credentials). {{ en.VLT_MAJ }} content types limit the entry types that can be created in this specific {{ en.VLT }}.
