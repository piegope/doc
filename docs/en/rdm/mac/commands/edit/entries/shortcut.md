...
![Two shortcut selected](https://cdnweb.devolutions.net/docs/en/rdm/mac/clip10001.png)
...
![Context menu - Create Shortcut](https://cdnweb.devolutions.net/docs/en/rdm/mac/clip10334.png)

Another way to create a shortcut is using the ***Edit menu - Create Shortcut***.
![Edit ribbon - Create Shortcut](https://cdnweb.devolutions.net/docs/en/rdm/mac/clip10335.png)
...
![Entry Group/Folder](https://cdnweb.devolutions.net/docs/en/rdm/mac/clip10603.png)
