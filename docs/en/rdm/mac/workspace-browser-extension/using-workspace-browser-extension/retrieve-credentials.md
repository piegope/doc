...
![Settings Icon](https://cdnweb.devolutions.net/docs/en/rdm/mac/RDMMac2051.png)
1. Click on ***General*** in the ***Configuration*** section.
![Settings – Configuration – General](https://cdnweb.devolutions.net/docs/en/rdm/mac/RDMMac2027.png)
1. In the ***General*** tab, the ***Show icon in fields*** setting should be enabled by default. If not, check the box next to the option to enable it.
   ...
   ![General – Show icon in fields](https://cdnweb.devolutions.net/docs/en/rdm/mac/RDMMac2028.png)

1. Click ***Save***.
1. Click on ***{{ en.RDM }}*** in the ***Data sources*** section.
![Settings – Data sources – {{ en.RDM }}](https://cdnweb.devolutions.net/docs/en/rdm/mac/RDMMac2029.png)
...
![Actions – Automatically retrieve and fill credentials on page load](https://cdnweb.devolutions.net/docs/en/rdm/mac/RDMMac2030.png)
...
![Automatically Filled Credentials Fields](https://cdnweb.devolutions.net/docs/en/rdm/mac/RDMMac2053.png)
{type="a"}
...
![Entry Filter and Selection](https://cdnweb.devolutions.net/docs/en/rdm/mac/RDMMac2054.png)
...
![Entry Selection](https://cdnweb.devolutions.net/docs/en/rdm/mac/RDMMac2055.png)
...
![Credentials Transfer in Corresponding Fields](https://cdnweb.devolutions.net/docs/en/rdm/mac/RDMMac2052.png)
