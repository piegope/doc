...
![Registration Page](https://cdnweb.devolutions.net/docs/en/rdm/mac/RDMMac2008.png)
...
![Password Generator Tab](https://cdnweb.devolutions.net/docs/en/rdm/mac/RDMMac2009.png)
...
![Password length](https://cdnweb.devolutions.net/docs/en/rdm/mac/RDMMac2010.png)
{type="a"}
...
![General Settings](https://cdnweb.devolutions.net/docs/en/rdm/mac/RDMMac2011.png)
...
![Advanced Settings](https://cdnweb.devolutions.net/docs/en/rdm/mac/RDMMac2012.png)
...
![Generate Password](https://cdnweb.devolutions.net/docs/en/rdm/mac/RDMMac2013.png)
1. Click on the ***Copy to Clipboard*** button to copy the password.
![Copy to Clipboard](https://cdnweb.devolutions.net/docs/en/rdm/mac/RDMMac2014.png)
1. Paste your password in the website's corresponding field.
![Paste Password](https://cdnweb.devolutions.net/docs/en/rdm/mac/RDMMac2015.png)
...
![Add Website](https://cdnweb.devolutions.net/docs/en/rdm/mac/RDMMac2016.png)
