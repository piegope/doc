...
This topic assumes that you have previously [installed the {{ en.WBEX }}](/rdm/mac/dwl/installation/) in your browser and that it is [connected to {{ en.RDMMAC }}](/rdm/mac/dwl/first-login-devolutions-web-login/). 
{% endsnippet %}
