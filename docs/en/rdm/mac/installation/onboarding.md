...
eleventyComputed:
  title: Onboarding
  description: When opening your {{ en.RDM }} application for the first time, an Onboarding process will begin to help you get started with {{ en.RDMMAC }}.
---
When opening your {{ en.RDM }} application for the first time, an Onboarding process will begin to help you get started with {{ en.RDMMAC }}. Here are the steps that you will go through during this initial configuration.
...
![Team (Subscription)](https://webdevolutions.azureedge.net/docs/en/rdm/mac/RDMMac2085.png)  
...
![Manage your entries](https://webdevolutions.azureedge.net/docs/en/rdm/mac/RDMMac2086.png)  
...
![User Interface Profile](https://webdevolutions.azureedge.net/docs/en/rdm/mac/RDMMac2090.png)  
...
![UI Options](https://webdevolutions.azureedge.net/docs/en/rdm/mac/RDMMac2088.png)  
...
![Join the community](https://webdevolutions.azureedge.net/docs/en/rdm/mac/RDMMac2089.png)  
