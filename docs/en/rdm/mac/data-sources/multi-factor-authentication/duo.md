...
![Apply Multi-Factor Configuration](https://cdnweb.devolutions.net/docs/docs_en_rdm_mac_clip10141.png)
...
![Duo Settings](https://cdnweb.devolutions.net/docs/docs_en_rdm_mac_clip10143.png)
...
![Multi-Factor Configuration – Settings](https://cdnweb.devolutions.net/docs/docs_en_rdm_mac_RDMMac2059.png)
...
![Close the Multi-Factor Configuration Window](https://cdnweb.devolutions.net/docs/docs_en_rdm_mac_RDMMac2060.png)
