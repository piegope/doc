...
![Add a new data source](https://cdnweb.devolutions.net/docs/RDMM2000_2024_1.png)
1. Select the type of data source to create, then click ***OK***. In the example below, a {{ en.DVLS }} data source is being created.
![Data source type selection](https://cdnweb.devolutions.net/docs/RDMM2001_2024_1.png)
...
![Data source configuration](https://cdnweb.devolutions.net/docs/RDMM2002_2024_1.png)
