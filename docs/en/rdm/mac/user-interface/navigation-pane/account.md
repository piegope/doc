...
![Account tab](https://webdevolutions.azureedge.net/docs/en/rdm/mac/RDMMac2075.png)  
...
Under ***Settings***, you can choose the [theme](/rdm/mac/user-interface/customization/theme/) of your RDM application between the ***Light*** theme and the ***Dark*** theme. You can also choose to mirror your system's theme.  

Next, you can also change the [style of the main header (top menu)](/rdm/mac/user-interface/ribbon/) of your RDM application. Choose between a ***Ribbon*** view or a ***Classic*** view.
...
The profile can also be selected during the RDM Onboarding process. If none is chosen or if the user decides to choose one later, they will be assigned the ***Default*** profile, which can be changed in ***File – Preferences – User Interface – Usage profile*** or in the web interface.  
