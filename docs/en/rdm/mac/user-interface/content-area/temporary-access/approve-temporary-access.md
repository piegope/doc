...
![Dashboard – pending access requests](https://webdevolutions.azureedge.net/docs/en/rdm/mac/RDMMac6005.png) 
...
![Pending Access Requests](https://webdevolutions.azureedge.net/docs/en/rdm/mac/RDMMac6006.png) 
...
![View messages](https://webdevolutions.azureedge.net/docs/en/rdm/mac/RDMMac6016.png) 

The ***Request message*** window opens.

![Request message](https://webdevolutions.azureedge.net/docs/en/rdm/mac/RDMMac6007.png) 
...
![Pending Access Requests](https://webdevolutions.azureedge.net/docs/en/rdm/mac/RDMMac6008.png) 
...
![Temporary Access Response](https://webdevolutions.azureedge.net/docs/en/rdm/mac/RDMMac6014.png) 
