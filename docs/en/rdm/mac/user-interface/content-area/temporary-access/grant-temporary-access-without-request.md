...
![Grant Temporary Access](https://cdnweb.devolutions.net/docs/docs_en_rdm_mac_RDMMac6010.png)
1. Choose ***User*** and ***Access Duration*** in the ***Grant Temporary Access*** window.
![Grant Temporary Access window](https://cdnweb.devolutions.net/docs/docs_en_rdm_mac_RDMMac6011.png)
...
![The temporary access has been granted](https://cdnweb.devolutions.net/docs/docs_en_rdm_mac_RDMMac6012.png)
