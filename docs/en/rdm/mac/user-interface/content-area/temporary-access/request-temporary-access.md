...
![Revoke temporary access](https://webdevolutions.blob.core.windows.net/docs/en/rdm/mac/RDMMac6003.png) 
1. Click ***Yes*** when asked if you are sure you want to revoke your temporary access.  
![Confirm temporary access revocation](https://webdevolutions.blob.core.windows.net/docs/en/rdm/mac/RDMMac6004.png) 
