...
![Send a temporary access request](https://cdnweb.devolutions.net/docs/en/rdm/mac/RDMMac6000.png)
...
![Temporary Access Request](https://cdnweb.devolutions.net/docs/en/rdm/mac/RDMMac6001.png)
...
![Revoke temporary access](https://cdnweb.devolutions.net/docs/en/rdm/mac/RDMMac6003.png)
1. Click ***Yes*** when asked if you are sure you want to revoke your temporary access.
![Confirm temporary access revocation](https://cdnweb.devolutions.net/docs/en/rdm/mac/RDMMac6004.png)
