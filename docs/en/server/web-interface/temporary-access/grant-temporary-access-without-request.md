...
![Grant Temporary Access](https://webdevolutions.azureedge.net/docs/en/server/ServerOp6027.png)  
1. Choose ***User*** and ***Access duration*** in the ***Grant Temporary Access*** window.  
![Grant Temporary Access window](https://webdevolutions.azureedge.net/docs/en/server/ServerOp6030.png)  
