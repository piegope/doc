---
eleventyComputed:
  title: '{{ en.VLT }} access in {{ en.DVLS }}'
...
{{ en.VLT }} visibility is of great importance in {{ en.DVLS }}, as access requests can only be performed for public {{ en.VLT }}s and not private ones.
...
1. Go to ***Administration – Configuration – System Settings – {{ en.VLT }} Management***.
...
1. In the web interface for {{ en.DVLS }}, make sure you are connected to the right data source.
1. Go to ***Administration – Security Management – {{ en.VLT }}s***.
