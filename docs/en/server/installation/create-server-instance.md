...
3. In the {{ en.DVLSCONSOLE }}, click on the ***New*** button or the ***Install New Instance*** button to deploy a new server instance using the <a href="#Basic">***Basic Installation***</a> or the <a href="#Advanced">***Advanced Installation***</a> wizard. It is also possible to ***Migrate SQL Data Source***.
...
11. Under ***Settings***, validate the configuration and click ***Install***.  
