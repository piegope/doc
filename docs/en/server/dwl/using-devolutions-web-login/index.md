...
This topic assumes that you have previously [installed the {{ en.WBEX }} extension](/server/dwl/installation/) in your browser and that it is [connected to {{ en.DVLS }}](/server/dwl/first-login-dwl/). 
{% endsnippet %}
