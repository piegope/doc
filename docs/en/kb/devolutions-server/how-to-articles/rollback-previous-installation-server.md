...
1. Create a new {{ en.DVLS }} instance and connect it to the restored database.
   1. Use steps 3 to 6 on the following [page](/server/installation/create-server-instance/).  
      ![!!KB4647](https://webdevolutions.azureedge.net/docs/en/kb/KB4647.png)
      {type="a"}
1. Select the DPS offline zip file and set the Installation Destination parameters.  
   ![!!KB4648](https://webdevolutions.azureedge.net/docs/en/kb/KB4648.png)
1. Click on the install button to Import the Encryption Keys.  
   ![!!KB4649](https://webdevolutions.azureedge.net/docs/en/kb/KB4649.png)  
   ![!!KB4650](https://webdevolutions.azureedge.net/docs/en/kb/KB4650.png)  
   ![!!KB4651](https://webdevolutions.azureedge.net/docs/en/kb/KB4651.png)  
   ![!!KB4652](https://webdevolutions.azureedge.net/docs/en/kb/KB4652.png)  
