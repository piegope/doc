...
We strongly recommend storing the Encryption keys file in a secure storage outside of {{ en.DVLS }} like {{ en.PHUB }} Business, Azure Key Vault or AWS Key Management Service.
{% endsnippet %}  
