...
* <a href="#one">Empty User Vault on both {{ en.RDM }} and the web {{ en.DVLS }} UI</a>
* <a href="#both">Empty User Vault in {{ en.RDM }}, but it is showing on the web {{ en.DVLS }} UI</a>

### Empty User Vault on both {{ en.RDM }} and the web {{ en.DVLS }} UI
<a name="one"></a>
