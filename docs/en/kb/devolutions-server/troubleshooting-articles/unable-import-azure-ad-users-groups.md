...
---
It's possible that the Azure AD cache stored in {{ en.DVLS }} isn't properly loaded. Here are the steps to troubleshoot this problem.
...
1. On the {{ en.DVLS }} Console, go in the ***Companions*** tab and stop the ***Scheduler Service***.  
...
1. Back in the {{ en.DVLS }} Console, go in the ***Companions*** to start the ***Scheduler Service***  
