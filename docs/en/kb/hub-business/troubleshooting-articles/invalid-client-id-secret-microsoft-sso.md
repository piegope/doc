...
![Invalid client ID or secret error message](https://webdevolutions.azureedge.net/docs/en/kb/KB2319.png)  
...
![App registrations](https://webdevolutions.azureedge.net/docs/en/kb/KB2321.png)  
...
![Enterprise applications](https://webdevolutions.azureedge.net/docs/en/kb/KB2320.png)  
...
![New client secret](https://webdevolutions.azureedge.net/docs/en/hub/Hub2151.png)  
...
1. Log in to {{ en.DHUBB }} using another connection method than Microsoft SSO, such as the {{ en.DA }} method.  
