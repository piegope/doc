...
![!!KB4060](https://webdevolutions.azureedge.net/docs/en/kb/KB4060.png)
1. Expand the ***SQL Server Network Configuration***.
1. Select an instance.  
![!!KB4245](https://webdevolutions.azureedge.net/docs/en/kb/KB4245.png)
1. Right-click the desired protocol, then select ***Enable***.  
![!!KB4230](https://webdevolutions.azureedge.net/docs/en/kb/KB4230.png)
...
![!!KB4277](https://webdevolutions.azureedge.net/docs/en/kb/KB4277.png)
1. Select ***Inbound Rules*** in the left pane.
1. Right-click ***Inbound Rules*** and select ***New Rule***.  
![!!KB4278](https://webdevolutions.azureedge.net/docs/en/kb/KB4278.png)
1. In the ***Rule Type*** page, select ***Port***, then click ***Next***.  
![!!KB4279](https://webdevolutions.azureedge.net/docs/en/kb/KB4279.png)
...
![!!KB4280](https://webdevolutions.azureedge.net/docs/en/kb/KB4280.png)  

7. In the ***Action*** page, select ***Allow the connection***, then click ***Next***.  
![!!KB4281](https://webdevolutions.azureedge.net/docs/en/kb/KB4281.png)
1. In the ***Profile*** page, select the profiles that describe the computer connection environment, then click ***Next***.  
![!!KB4282](https://webdevolutions.azureedge.net/docs/en/kb/KB4282.png)
1. In the ***Name*** page, enter a ***Name*** and ***Description*** for the rule, then click ***Finish***.  
![!!KB4283](https://webdevolutions.azureedge.net/docs/en/kb/KB4283.png)
...
![!!KB4246](https://webdevolutions.azureedge.net/docs/en/kb/KB4246.png)
...
![!!KB4247](https://webdevolutions.azureedge.net/docs/en/kb/KB4247.png)  
...
![!!KB4248](https://webdevolutions.azureedge.net/docs/en/kb/KB4248.png)
...
![!!KB2009](https://webdevolutions.azureedge.net/docs/en/kb/KB2009.png)  
