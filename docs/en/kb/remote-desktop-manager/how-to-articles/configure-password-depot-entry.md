...
eleventyComputed:
  ...
  - Password Depot
---
Every field from the ***Password Depot*** synchronizer entry is described below.
...
![Credential Management](https://webdevolutions.azureedge.net/docs/en/kb/KB00.png)  
![General tab](https://webdevolutions.azureedge.net/docs/en/kb/KB00.png)  
