---
eleventyComputed:
  title: Devolutions Workspace setup for mobile with {{ en.HUBP }}
...
Follow the steps below to perform the initial configuration of your {{ en.WS }} mobile application with {{ en.HUBP }}:
...
1. In the ***Workspace Setup***, check ***{{ en.DHUB }} Personal***, then tap on ***Start Setup***.
![{{ en.DHUB }} Personal setup](https://webdevolutions.azureedge.net/docs/en/hub/Hub2215.png)
...
![{{ en.DA }}](https://webdevolutions.azureedge.net/docs/en/hub/Hub2216.png)
1. Back to the {{ en.WS }} setup, choose to either back up your entries on {{ en.DHUB }} Personal or not back them up. Backing up your entries on {{ en.DHUB }} Personal is recommended as you will be able to access them from any device.  
![Back up entries on {{ en.HUBP }}](https://webdevolutions.azureedge.net/docs/en/hub/Hub2217.png)
1. Tap ***Next***.
