---
eleventyComputed:
  title: Devolutions Workspace desktop setup with {{ en.DHUBB }}
...
Follow the steps below to perform the initial configuration of your {{ en.DWSDESKTOP }} application with {{ en.DHUBB }}:
