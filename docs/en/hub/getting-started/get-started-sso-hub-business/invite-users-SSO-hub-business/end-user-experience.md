---
eleventyComputed:
  title: End User Invitation Experience for SSO in {{ en.HUB }} Business
...
Users that are invited to join {{ en.HUB }} Business receive this email from their administrator.  
...
The user in now connected and is ready to use {{ en.HUB }} Business. 
