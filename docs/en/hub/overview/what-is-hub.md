...
Centralize, Manage, and Secure Remote Connections  
	...
	<tr>
		<td>
Devolutions Workspace is a mobile and desktop application that brings together Authenticator, {{ en.HUB }} Business, {{ en.HUB }} Personal, and {{ en.VLS }} into a single, centralized, cloud-based location. 
		</td>
		<td>
