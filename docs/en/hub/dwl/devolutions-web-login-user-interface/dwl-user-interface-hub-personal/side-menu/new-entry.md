...
Folder 
		...
		<td>
Enter the name of the folder in which your new entry will be stored in {{ en.PHUB }} Personal. 
		</td>
	</tr>
	<tr>
		<td>
Select Folder 
		...
		<td>
Select in a tree view the folder in which your new entry will be stored in {{ en.PHUB }} Personal. You can also create a new folder and edit or delete existing ones. 
		</td>
	</tr>
	<tr>
		<td>
...
Follow our step-by-step guide explaining [how to add an entry](/hub/dwl/using-devolutions-web-login/using-dwl-with-hub-personal/add-entry-hub-personal-dwl/) in {{ en.PHUB }} Personal with {{ en.DWL }} . 
{% endsnippet %}
