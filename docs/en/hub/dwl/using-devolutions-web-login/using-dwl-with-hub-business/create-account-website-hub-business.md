...
![Generate Password](https://webdevolutions.azureedge.net/docs/en/hub/Hub2051.png) 
1. Click on the ***Copy to Clipboard*** button to copy the password.  
![Copy to Clipboard](https://webdevolutions.azureedge.net/docs/en/hub/Hub2052.png) 
