...
---
***Temporary Password*** are created automatically for new users who are invited to {{ en.HUBB }} and who do not have {{ en.DA }}.  
...
In the invite process, when a {{ en.DA }} is found for the user, it will automatically link the account to {{ en.HUBB }}.  
...
In the ***Mass invite report*** window, you will be required to copy or download the ***Temporary Password*** PDF for each of your users. This is mandatory, since they will need the ***Temporary Password*** to access {{ en.HUBB }}.  
