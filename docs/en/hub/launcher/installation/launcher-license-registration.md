...
![!!Hub4007](https://webdevolutions.azureedge.net/docs/en/hub/Hub4007.png) 
1. Paste the ***License*** and click ***Add***.  
![!!Hub4008](https://webdevolutions.azureedge.net/docs/en/hub/Hub4008.png) 
1. Click the ***Edit*** button next to the product ***{{ en.DLAUNCHER }}*** license.  
![!!Hub4010](https://webdevolutions.azureedge.net/docs/en/hub/Hub4010.png) 
1. Click ***Assigned To*** and manage your users license access.  
![!!Hub4011](https://webdevolutions.azureedge.net/docs/en/hub/Hub4011.png) 
