...
1. Next to the ***Host*** field click on the 3 dots to select your {{ en.DHUB }} Business data source and click ***OK*** to save.  

You can close the ***Data Sources*** window, you are now connected to your {{ en.DHUB }} Business with Launcher.  
